...
ConversationDST::setUp()
{
    ...
    if (not Manager::instance().initialized)
        CPPUNIT_ASSERT(libjami::start("dst-config.yml"));
 ...
 */
void
ConversationDST::displaySummary()
{
 ...
 */
void
ConversationDST::generateEventSequence()
{
