...
ConversationDST::triggerEvent(const Event& event)
{
    ...
    case ConversationEvent::CLONE: {
        ...
        repositoryAccounts[event.receivingAccountIndex]
            .client.onConversationReady(repositoryAccounts[event.receivingAccountIndex].account->getAccountID(),
                                        repositoryAccounts[event.receivingAccountIndex].repository->id());
