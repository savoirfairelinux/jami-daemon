                                   ...
                                   const TestScenario& scenario)
{
    ...
    // Update the media
    auto mediaListUpdate = MediaAttribute::mediaAttributeToMediaMap(scenario.offerUpdate_);
    Manager::instance().requestMediaUpdate(aliceData.sipCall_->getCallId(), mediaListUpdate);
