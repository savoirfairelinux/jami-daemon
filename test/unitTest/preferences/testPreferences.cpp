...
namespace ring_test {
    class PreferencesTest : public CppUnit::TestFixture {
        ...
        private:
            ...
            ring::VoipPreference *voipPreference;
            ring::HookPreference *hookPreference;
            ring::AudioPreference *audioPreference;
            ring::ShortcutPreferences *shortcutPreferences;
            //ring::VideoPreferences *videoPreferences;
    };
    ...
    PreferencesTest::setUp()
    {
        ...
        voipPreference = new ring::VoipPreference();
        hookPreference = new ring::HookPreference();
        audioPreference = new ring::AudioPreference();
        shortcutPreferences = new ring::ShortcutPreferences();
        //videoPreferences = new ring::VideoPreferences();
    }
    ...
    {
        delete preferences;
        delete voipPreference;
        delete hookPreference;
        delete audioPreference;
        delete shortcutPreferences;
        //delete videoPreferences;
    }
