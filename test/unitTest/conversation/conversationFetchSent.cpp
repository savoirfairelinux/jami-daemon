...
ConversationFetchSentTest::testSyncFetch()
{
    ...
    CPPUNIT_ASSERT(cv.wait_for(lk, 30s, [&]() {
        JAMI_ERROR("@@@ aliceData.messages.size() {} - aliceMsgSize {} - bobData.messages.size() {} - bobMsgSize {} - bob2Data.messages.size() {} - bob2MsgSize {}", aliceData.messages.size(), aliceMsgSize, bobData.messages.size(), bobMsgSize, bob2Data.messages.size(), bob2MsgSize);
    ...
    CPPUNIT_ASSERT(cv.wait_for(lk, 30s, [&]() {
        ...
        JAMI_ERROR("@@@ bobData: {} - bob2Data: {}", bobData.status[msgId1], bob2Data.status[msgId1]);
        JAMI_ERROR("@@@ bobData: {} - bob2Data: {}", bobData.status[msgId2], bob2Data.status[msgId2]);
        JAMI_ERROR("@@@ bobData: {} - bob2Data: {}", bobData.status[msgId3], bob2Data.status[msgId3]);
        JAMI_ERROR("@@@ bobData: {} - bob2Data: {}", bobData.status[msgId4], bob2Data.status[msgId4]);
