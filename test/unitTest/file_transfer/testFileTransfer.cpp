...
FileTransferTest::setUp()
{
    ...
    std::cout << "========" << Manager::instance().getAccount(Manager::instance().getAccountList()[0])->getVolatileAccountDetails().at("Account.registrationStatus") << std::endl;
...
void
FileTransferTest::testIncomingFile()
{
    sendFile();
