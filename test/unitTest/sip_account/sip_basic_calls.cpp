...
private:
    ...
    CPPUNIT_TEST(call_transfer_test);
...
SipBasicCallTest::hold_resume_test()
{
...

    {
        ...
        DRing::unhold(aliceData_.callId_);
...
void
SipBasicCallTest::call_transfer_test()
{
