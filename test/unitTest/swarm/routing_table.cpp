...
void
RoutingTableTest::testClosestNodes()
{
    SwarmManager sm1(nodeTestIds1.at(0));
    sm1.setKnownNodes(nodeTestIds1);
    auto& r1 = sm1.getRoutingTable();

    NodeId node("4ea6002f7496c9fa4869fef2013d06c90c6aacb1e233bb53748a56b3d39a5522");
    std::vector<NodeId> closeNodes = r1.closestNodes(node, 4);
