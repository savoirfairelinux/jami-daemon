...
RoutingTableTest::testBucketSplit_1n()
{
    ...
    for (const auto& buckIt : b1) {
        ...
        case 2:
            ...
            CPPUNIT_ASSERT_EQUAL_MESSAGE("Supposed to have node ntc2 3",
                                         true,
                                         buckIt.hasNode(nodeTestChannels2.at(3)->deviceId()));
            CPPUNIT_ASSERT_EQUAL_MESSAGE("Supposed to have node ntc2 4",
                                         true,
                                         buckIt.hasNode(nodeTestChannels2.at(4)->deviceId()));
            CPPUNIT_ASSERT_EQUAL_MESSAGE("Supposed to have node ntc2 8",
                                         true,
                                         buckIt.hasNode(nodeTestChannels2.at(8)->deviceId()));
