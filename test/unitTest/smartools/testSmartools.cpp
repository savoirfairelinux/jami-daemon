...
namespace ring { namespace test {
    ...
    SmartoolsTest::testSetLocalInformation()
    {
        ...
        CPPUNIT_ASSERT(map_compare(localInformation_,Smartools::getInstance().getInformation()));
    ...
    SmartoolsTest::testSetRemoteInformation()
    {
        ...
        CPPUNIT_ASSERT(map_compare(remoteInformation_,Smartools::getInstance().getInformation()));
...
RING_TEST_RUNNER(ring::test::SmartoolsTest::name())
