...
namespace ring_test {
    ...
    private:
        ...
        std::map<std::string, std::string> information1_;
        std::map<std::string, std::string> information2_;
    ...
    {
        // initialisation information1_
        information1_["local FPS"]= "32";
        information1_["local width"]="326";
        information1_["local height"] ="532";
        information1_["remote audio codec"]= "remoteAudioCodec";
        information1_["local audio codec"]= "localAudioCodec";
        information1_["local video codec"]= "localVideoCodec";
        ...
        CPPUNIT_ASSERT(map_compare(information1_,ring::Smartools::getInstance().getInformation()));
    }
