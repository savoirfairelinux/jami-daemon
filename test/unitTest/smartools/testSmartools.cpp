...
namespace ring {
    ...
    SmartoolsTest::testSetLocalInformation()
    {
        ...
        CPPUNIT_ASSERT(map_compare(localInformation_,Smartools::getInstance().information_));
    ...
    SmartoolsTest::testSetRemoteInformation()
    {
        ...
        CPPUNIT_ASSERT(map_compare(remoteInformation_,Smartools::getInstance().information_));
