...
namespace ring {
    ...
    SmartoolsTest::testSetLocalInformation()
    {
        ...
        CPPUNIT_ASSERT(std::equal(localInformation.begin(),localInformation.end(),
            Smartools::getInstance().information_.begin(), Smartools::getInstance().information_.end()));
    ...
    SmartoolsTest::testSetRemoteInformation()
    {
        ...
        CPPUNIT_ASSERT(std::equal(remoteInformation.begin(),remoteInformation.end(),
            Smartools::getInstance().information_.begin(), Smartools::getInstance().information_.end()));
