                                          ...
                                          const TestScenario& scenario)
{
    ...
    if (scenario.expectMediaChangeRequest_) {
        ...
        // Bob has auto answer enabled, so the media change request using
...
void
AutoAnswerMediaNegoTest::audio_and_video_answer_muted_audio_then_mute_audio()
{
    JAMI_INFO("=== Begin test %s ===", __FUNCTION__);
...
void
AutoAnswerMediaNegoTest::audio_and_video_answer_muted_video_then_mute_video()
{
    JAMI_INFO("=== Begin test %s ===", __FUNCTION__);
...
// TODO. Add Jami version.
JAMI_TEST_RUNNER(jami::test::AutoAnswerMediaNegoTestSip::name())
