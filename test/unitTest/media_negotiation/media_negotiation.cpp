...
private:
    ...
    void onIncomingCall(const std::string& accountId,
    ...
    DRing::MediaMap createMediaMap(const MediaAttribute& mediaAttr);
                                     ...
                                     CallData& callData)
{
    ...
    // Answer the call.
    Manager::instance().answerCallWithMedia(callId, mediaList);
                                       ...
                                       const TestScenario& scenario)
{
    ...
    Manager::instance().updateMediaStreams(aliceData.callId_, mediaList);
