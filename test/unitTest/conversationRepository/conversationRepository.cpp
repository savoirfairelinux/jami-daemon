...
private:
    ...
    bool merge_in_master(git_repository* repo, const std::string& commit_ref);
...
bool
ConversationRepositoryTest::merge_in_master(git_repository* repo, const std::string& commit_ref)
{
