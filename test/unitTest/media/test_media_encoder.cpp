...
void
MediaEncoderTest::testFileEncoding()
{
    ioHandle_.reset(); // want nullptr in here

    std::map<std::string, std::string> options; // keep default values
