...
VideoMixerPolicyTest::testOneBigWithSmallKeepsPreviewsUsable()
{
    ...
    std::vector<VideoMixer::SourceSpec> sources {{720, 480, 30, true}, {1280, 720, 30, false}, {1280, 720, 30, false}};
    ...
    std::vector<VideoMixer::SourceSpec> share {{3840, 2160, 30, true}, {1280, 720, 30, false}, {1280, 720, 30, false}};
