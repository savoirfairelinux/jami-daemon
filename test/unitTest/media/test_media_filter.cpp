...
MediaFilterTest::testVideoFilter()
{
    ...
    frame->width = width;
    frame->height = height;
    CPPUNIT_ASSERT(frame->width == width && frame->height == height);
    ...
    codecCtx->sample_aspect_ratio.num = 1;
    codecCtx->sample_aspect_ratio.den = 1;
    ...
    CPPUNIT_ASSERT(frame->width == 200 && frame->height == 100);
}
