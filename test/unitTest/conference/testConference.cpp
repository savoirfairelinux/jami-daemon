...
namespace ring_test {
    ...
    private:
        ...
        CPPUNIT_TEST(getConfIDTest);
        CPPUNIT_TEST(stateTest);
        CPPUNIT_TEST(manageParticipants);
        CPPUNIT_TEST(toggleRecordingTest);
        CPPUNIT_TEST(deletePointer);
        CPPUNIT_TEST_SUITE_END();

        ring::Conference* conference = new ring::Conference();
    };
    ...
    void
    ConferenceTest::manageParticipants()
    {
    ...
    void
    ConferenceTest::toggleRecordingTest()
    {
