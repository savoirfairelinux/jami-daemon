...
namespace ring { namespace fileutils { namespace test {
    ...
    private:
        ...
        const std::string NON_EXISTANT_PATH_BASE = FILEUTILS_PATH + DIR_SEPARATOR_STR
            + "test_mkdir_dir";
    ...
    FileutilsTest::testFullPath()
    {
        ...
        CPPUNIT_ASSERT(getFullPath(NON_EXISTANT_PATH_BASE,NON_EXISTANT_PATH).compare(NON_EXISTANT_PATH)==0);
