...
namespace ring { namespace test {
    class ImplementThreadloop
    {
        public:
            ImplementThreadloop();
            //ImplementThreadloop(std::string setThreadloop);
            ~ImplementThreadloop();
            void start();
            void stop();
    ...
    /*ImplementThreadloop::ImplementThreadloop(std::string setThreadloop)
    : loop_([this] { setup(); }, [this] { process(); }, [] {})
    {}*/
...
////////////////////////////////////////////////////////////////////////////////
    ...
    ThreadloopTest::threadloopTest()
    {
        ...
        implementThreadloop->stop();
        CPPUNIT_ASSERT(implementThreadloop->getMultiThreadVar()==3);
