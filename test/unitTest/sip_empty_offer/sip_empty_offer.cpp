...
private:
    ...
    // void audio_video_with_ice_test();
                                    ...
                                    std::vector<MediaAttribute> answer)
{
    ...
    // Validate Alice's media
    {
        ...
        // TODO_MC. Enable this once SDP nego is fixed.
...
{
    auto const bobAcc = Manager::instance().getAccount<SIPAccount>(aliceData_.accountId_);
