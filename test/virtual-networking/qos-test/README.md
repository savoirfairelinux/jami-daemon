...
`SocketPair` layer. Allows writing unit tests that configure packet loss and
bandwidth limits without any network setup. For jitter simulation, use tc/netem.
