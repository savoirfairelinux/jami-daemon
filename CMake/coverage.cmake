...
if(COVERAGE_TOOLS_AVAILABLE OR GCOVR_PATH)
    ...
    # coverage-cleaner target (more thorough cleanup)
    ...
    if(COVERAGE_TOOLS_AVAILABLE)
        ...
        add_custom_target(coverage-html
            ...
            COMMAND ${LCOV_PATH} --no-external --capture --initial --directory ${CMAKE_BINARY_DIR} --output-file jami-coverage-base.info || ${CMAKE_COMMAND} -E touch jami-coverage-base.info
            # Capture test execution data
            COMMAND ${LCOV_PATH} --no-external --capture --directory ${CMAKE_BINARY_DIR} --output-file jami-coverage-tests.info
