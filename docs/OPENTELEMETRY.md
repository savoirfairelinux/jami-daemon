...
|----------|--------|---------|---------|
| `JAMI_OTEL_EXPORTER` | `otlp_http`, `otlp_grpc`, `stdout`, `none` | `stdout` | Which exporter backend to use for traces, metrics, and logs |
...
**Quick example — send everything to a local Jaeger:**
