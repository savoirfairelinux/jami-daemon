...
ConfigurationDialog::ConfigurationDialog(QDialog *parent) : QDialog(parent)
{
	...
	//configuration dbus
	registerCommTypes();
	//daemon = new DaemonInterface("org.sflphone.SFLphone", "/org/sflphone/SFLphone/ConfigurationManager", QDBusConnection::sessionBus(), this);
...
{
	DaemonInterface & daemon = DaemonInterfaceSingleton::getInstance();
...
void ConfigurationDialog::loadAccountList()
{
	...
	QDBusReply<QStringList> r = (DaemonInterfaceSingleton::getInstance().getAccountList());
