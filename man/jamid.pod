...
Log to the console. This is the implicit default when the daemon is
connected to a TTY.

=item B<--syslog>

Log via syslog. This is the implicit default when the daemon
is B<not> connected to a TTY.
