...
def parse_args():
    ...
    ap.add_argument(
        '-c', '--clean',
        help='Cleans out build directory for ')
    ap.add_argument(
...
def main():
    ...
    if parsed_args.clean:
        if os.path.exists(contrib_build_dir) and parsed_args.clean == 'all':
            ...
            dir_to_clean = contrib_build_dir + '\\' + parsed_args.clean
            file_to_clean = contrib_build_dir + '\\.' + parsed_args.clean
