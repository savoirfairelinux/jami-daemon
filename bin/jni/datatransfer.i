...
public:
    ...
    virtual void dataTransferEvent(const std::string& accountId, const std::string& conversationId, const std::string& peer, const DRing::DataTransferId transferId, int eventCode){}
};
%}
