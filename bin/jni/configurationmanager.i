...
public:
    ...
    virtual void collaborativeDocumentChanged(const std::string& /*account_id*/, const std::string& /*conversationId*/, const std::string& /*documentId*/, int /*index*/, int /*deleteLen*/, const std::string& /*insert*/){}
    virtual void collaborativeCursorChanged(const std::string& /*account_id*/, const std::string& /*conversationId*/, const std::string& /*documentId*/, const std::string& /*peerId*/, int /*position*/, int /*anchor*/){}
    ...
    virtual void collaborativeDocumentDelta(const std::string& /*account_id*/, const std::string& /*conversationId*/, const std::string& /*documentId*/, const std::string& /*deltaJson*/){}
};
%}
...
void updateProfile(const std::string& accountId, const std::string& displayName, const std::string& avatar, const std::string& fileType, const std::string& botOwner, int32_t flag);
