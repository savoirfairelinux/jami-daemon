...
public:
    ...
    virtual void vCardReceived(const std::string& /*account_id*/, const std::string& /*from*/, const std::string& /*vCard*/){}
...
void vCardReceived(const std::string& account_id, const std::string& from, const std::string& vCard);
