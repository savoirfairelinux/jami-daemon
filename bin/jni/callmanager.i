...
public:
    ...
    virtual void sipCallStateChange(const std::string& callId, const std::string& state, int code){}
...
std::map<std::string, std::string> getCallDetails(cconst std::string& accountId, onst std::string& callId);
...
bool isConferenceParticipant(const std::string& callId);
