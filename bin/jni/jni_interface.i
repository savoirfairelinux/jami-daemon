...
void init(ConfigurationCallback* confM, Callback* callM, PresenceCallback* presM, DataTransferCallback* dataM, VideoCallback* videoM, ConversationCallback* convM, NetworkServiceCallback* nsMgr) {
    ...
    const std::map<std::string, SharedCallback> configEvHandlers = {
        ...
        exportable_callback<ConfigurationSignal::CollaborativeDocumentUpdate>(bind(&ConfigurationCallback::collaborativeDocumentUpdate, confM, _1, _2, _3, _4)),
        exportable_callback<ConfigurationSignal::CollaborativeAwarenessChanged>(bind(&ConfigurationCallback::collaborativeAwarenessChanged, confM, _1, _2, _3, _4, _5, _6)),
        exportable_callback<ConfigurationSignal::CollaborativeParticipantLeft>(bind(&ConfigurationCallback::collaborativeParticipantLeft, confM, _1, _2, _3, _4, _5)),
        ...
        exportable_callback<ConfigurationSignal::CollaborativeDocumentRemoved>(bind(&ConfigurationCallback::collaborativeDocumentRemoved, confM, _1, _2, _3, _4)),
