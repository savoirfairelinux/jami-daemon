...
%native(captureVideoFrame) void captureVideoFrame(jobject, jint, jstring);
%native(captureVideoPacket) void captureVideoPacket(jobject, jint, jstring, jint, jboolean, jlong, jint);
