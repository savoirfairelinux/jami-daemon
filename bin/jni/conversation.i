...
public:
    ...
    virtual void swarmLoaded(uint32_t /* id */, const std::string& /*accountId*/, const std::string& /* conversationId */, std::vector<SwarmMessage> /*messages*/){}
    ...
    virtual void swarmMessageReceived(const std::string& /*accountId*/, const std::string& /* conversationId */, const SwarmMessage& /*message*/){}
    virtual void swarmMessageUpdated(const std::string& /*accountId*/, const std::string& /* conversationId */, const SwarmMessage& /*message*/){}
    ...
    virtual void reactionRemoved(const std::string& /*accountId*/, const std::string& /* conversationId */, const std::string& /* messageId */){}
