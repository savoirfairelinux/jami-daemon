...
2. You need [Ring](https://ring.cx/en/download) which will contain the Ring-daemon.
    ...
    **Note:** until patch [4482](https://gerrit-ring.savoirfairelinux.com/#/c/4482) are merged, you need to do it manually. See: [extra/dev-docs/install.md](extra/dev-docs/install.md).
