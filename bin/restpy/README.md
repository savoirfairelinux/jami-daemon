...
You can choose:
    ...
    1. Execute the *ring_api* Python module
    2. Import it into interpreter of your choice
    3. Use the soon integrated version of the Ring-daemon
