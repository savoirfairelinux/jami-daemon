...
Inspired from the [White House Web API Standards](https://github.com/WhiteHouse/api-standards) which [is under CC0 license](https://github.com/WhiteHouse/api-standards/issues/49).
...
Error responses should include a common HTTP status code and a message for the developer. For example:
