...
public:
    ...
    auto startCall(const std::string& accountId, const std::string& to) -> decltype(libjami::startCall(accountId, to))
    {
        return libjami::startCall(accountId, to);
    }
    auto startCallWithMedia(const std::string& accountId,
                            const std::string& to,
                            const std::vector<std::map<std::string, std::string>>& mediaList)
        -> decltype(libjami::startCallWithMedia(accountId, to, mediaList))
    {
        return libjami::startCallWithMedia(accountId, to, mediaList);
    }
