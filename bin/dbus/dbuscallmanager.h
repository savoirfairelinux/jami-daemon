...
public:
    ...
    bool acceptWithMedia(const std::string& accountId, const std::string& callId,
                         const std::vector<std::map<std::string, std::string>>& mediaList);
    bool answerMediaChangeRequest(const std::string& accountId, const std::string& callId,
                                  const std::vector<std::map<std::string, std::string>>& mediaList);
    ...
    bool muteLocalMedia(const std::string& accountId, const std::string& callid, const std::string& mediaType, const bool& mute);
    ...
    void removeConference(const std::string& accountId, const std::string& confId);
    ...
    void setConferenceLayout(const std::string& accountId, const std::string& confId, const uint32_t& layout);
