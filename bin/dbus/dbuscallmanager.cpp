...
auto
DBusCallManager::refuse(const std::string& accountId, const std::string& callId) -> decltype(DRing::refuse(accountId, callId))
{
    return DRing::refuse(accountId, callId);
}

auto
DBusCallManager::accept(const std::string& accountId, const std::string& callId) -> decltype(DRing::accept(accountId, callId))
{
...
DBusCallManager::answerMediaChangeRequest(
    const std::string& accountId, const std::string& callId, const std::vector<std::map<std::string, std::string>>& mediaList)
...
auto
DBusCallManager::hangUp(const std::string& accountId, const std::string& callId) -> decltype(DRing::hangUp(accountId, callId))
{
    return DRing::hangUp(accountId, callId);
}

auto
DBusCallManager::hold(const std::string& accountId, const std::string& callId) -> decltype(DRing::hold(accountId, callId))
{
    return DRing::hold(accountId, callId);
}

auto
DBusCallManager::unhold(const std::string& accountId, const std::string& callId) -> decltype(DRing::unhold(accountId, callId))
{
...
auto
DBusCallManager::transfer(const std::string& accountId, const std::string& callId, const std::string& to)
    -> decltype(DRing::transfer(accountId, callId, to))
{
    return DRing::transfer(accountId, callId, to);
}

auto
DBusCallManager::attendedTransfer(const std::string& accountId, const std::string& callId, const std::string& targetId)
...
void
DBusCallManager::removeConference(const std::string& accountId, const std::string& confId)
{
    DRing::removeConference(accountId, confId);
}

auto
DBusCallManager::joinParticipant(const std::string& accountId, const std::string& sel_callId, const std::string& drag_callId)
    -> decltype(DRing::joinParticipant(accountId, sel_callId, drag_callId))
{
    return DRing::joinParticipant(accountId, sel_callId, drag_callId);
}

void
DBusCallManager::createConfFromParticipantList(const std::string& accountId, const std::vector<std::string>& participants)
{
    DRing::createConfFromParticipantList(accountId, participants);
}

void
DBusCallManager::setConferenceLayout(const std::string& accountId, const std::string& confId, const uint32_t& layout)
{
    DRing::setConferenceLayout(accountId, confId, layout);
}

void
DBusCallManager::setActiveParticipant(const std::string& accountId, const std::string& confId, const std::string& callId)
{
...
auto
DBusCallManager::addParticipant(const std::string& accountId, const std::string& callId, const std::string& confId)
    -> decltype(DRing::addParticipant(accountId, callId, confId))
{
    return DRing::addParticipant(accountId, callId, confId);
}
...
auto
DBusCallManager::joinConference(const std::string& accountId,const std::string& sel_confId, const std::string& drag_confId)
    -> decltype(DRing::joinConference(accountId, sel_confId, drag_confId))
{
    return DRing::joinConference(accountId, sel_confId, drag_confId);
}
...
auto
DBusCallManager::getConferenceList(const std::string& accountId) -> decltype(DRing::getConferenceList(accountId))
{
...
bool
DBusCallManager::switchInput(const std::string& accountId, const std::string& callId, const std::string& input)
{
    return DRing::switchInput(accountId, callId, input);
}

bool
DBusCallManager::switchSecondaryInput(const std::string& accountId, const std::string& conferenceId, const std::string& input)
{
...
void
DBusCallManager::hangupParticipant(const std::string& accountId, const std::string& confId, const std::string& peerId)
{
