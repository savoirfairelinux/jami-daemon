...
uint64_t
DBusVideoManager::startLocalRecorder(bool audioOnly, std::string filename)
{
    return DRing::startLocalRecorder(audioOnly, filename);
}

void
DBusVideoManager::stopLocalRecorder(uint64_t id)
{
