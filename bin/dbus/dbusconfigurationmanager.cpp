...
void
DBusConfigurationManager::sendFile(const DBus::Struct<std::string, uint32_t, uint32_t, int64_t, int64_t, std::string, std::string, std::string, std::string>& in,
                                   ...
                                   uint32_t& error)
{
    ...
    info.path = in._8;
    info.mimetype = in._9;
    error = int(DRing::sendFile(info, id));
}

void
DBusConfigurationManager::dataTransferInfo(const DRing::DataTransferId& id,
                                           DBus::Struct<std::string, uint32_t, uint32_t, int64_t, int64_t, std::string, std::string, std::string, std::string>& out,
                                           uint32_t& error)
{
    DRing::DataTransferInfo info;
...
void
DBusConfigurationManager::dataTransferBytesProgress(const uint64_t& id, int64_t& total,
                                                    int64_t& progress, uint32_t& error)
{
