...
auto
DBusConfigurationManager::monitor() -> decltype(DRing::monitor())
{
                                   ...
                                   DRing::DataTransferId& id)
{
    ...
    info.peer = in._6;
    info.conversationId = in._7;
    info.displayName = in._8;
    info.path = in._9;
    info.mimetype = in._10;
                                           ...
                                           RingDBusDataTransferInfo& out)
{
    ...
    if (res == DRing::DataTransferError::success) {
        ...
        out._6 = info.peer;
        out._7 = info.conversationId;
        out._8 = info.displayName;
        out._9 = info.path;
        out._10 = info.mimetype;
    }
    error = uint32_t(res);
}
