...
auto
DBusConfigurationManager::exportAccounts(const std::vector<std::string>& accountIDs, const std::string& toDir, const std::string& password) -> decltype(DRing::exportAccounts(accountIDs, toDir, password))
{
    return DRing::exportAccounts(accountIDs, toDir, password);
}
