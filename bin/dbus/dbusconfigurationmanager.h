...
{
    public:
        using DBusDataTransferInfo = DBus::Struct<std::string, uint32_t, uint32_t, int64_t, int64_t, std::string, std::string, std::string, std::string>;
        ...
        void sendFile(const DBusDataTransferInfo& info, DRing::DataTransferId& id, uint32_t& error);
        void dataTransferInfo(const DRing::DataTransferId& id, DBusDataTransferInfo& info, uint32_t& error);
        void dataTransferBytesProgress(const uint64_t& id, int64_t& total, int64_t& progress, uint32_t& error);
