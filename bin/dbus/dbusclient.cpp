...
DBusClient::initLibrary(int flags)
{
    ...
    const std::map<std::string, SharedCallback> configEvHandlers = {
        ...
        exportable_callback<ConfigurationSignal::ContactAdded>(bind(&DBusConfigurationManager::contactAdded, confM, _1, _2 )),
        exportable_callback<ConfigurationSignal::ContactRemoved>(bind(&DBusConfigurationManager::contactRemoved, confM, _1, _2 )),
