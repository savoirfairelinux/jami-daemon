...
class CallFactory {
    public:
        ...
        std::shared_ptr<T> newCall(std::shared_ptr<A> account, const std::string& id, Call::CallType type,
            ...
            struct ConcreteCall : T {
                    ConcreteCall(std::shared_ptr<A> account, const std::string& id, Call::CallType type,
                                 const std::map<std::string, std::string>& details)
