...
private:
    ...
    mutable boost::nowide::ifstream input_;
...
public:
    ...
    void saveWaiting()
    {
        boost::nowide::ofstream file(waitingPath_, std::ios::trunc | std::ios::binary);
                      ...
                      int64_t& progress) const noexcept
{
    ...
    if (itI != pimpl_->incomings_.end()) {
        ...
        boost::nowide::ifstream transfer(path, std::ios::binary);
