...
private:
    ...
    std::vector<jami::Logger::Msg> messagesQA_;
    std::vector<jami::Logger::Msg> messagesQB_;
    std::vector<jami::Logger::Msg>* currentQ_{&messagesQA_};
    std::vector<jami::Logger::Msg>* pendingQ_{&messagesQB_};
    std::mutex mtx_;
