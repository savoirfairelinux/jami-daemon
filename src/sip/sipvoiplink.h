...
private:
    ...
    // Scheduler used to process SIP operations/events. All operations/events
    // involving SIP should be processed by this scheduler in order to perform
    // all SIP operations/events on the same thread. This will reduce thread
