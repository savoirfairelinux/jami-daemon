...
public:
     ...
     * (aka re-invite)
     */
    [[deprecated("Replaced by onReceiveReinvite")]] void onReceiveOffer(
...
private:
     ...
     */
    bool updateMediaStream(const MediaAttribute& newMediaAttr, size_t streamIdx);
    ...
    /**
     * Find the stream index with a matching label.
