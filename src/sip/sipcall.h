...
private:
    ...
    bool isAbandonedTransportLocked(const std::shared_ptr<SipTransport>& transport) const;
    ...
    std::optional<std::vector<libjami::MediaMap>> pendingMediaChange_;
