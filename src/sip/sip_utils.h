...
/// Copy content of a pj_str_t into a new std::string
inline std::string to_string(const pj_str_t& pj_str) {
    return std::string {pj_str.ptr, static_cast<unsigned>(pj_str.slen)};
}
