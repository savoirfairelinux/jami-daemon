...
SIPCall::createCallAVStreams()
{
    ...
    if (auto& localAudio = audioRtp->getAudioLocal()) {
        ...
        StreamData microStreamData {baseId, false, StreamType::audio, getAccountId()};
    ...
    if (auto& audioReceive = audioRtp->getAudioReceive()) {
        ...
        StreamData phoneStreamData {baseId, true, StreamType::audio, getAccountId()};
    ...
    if (hasVideo()) {
        ...
        if (auto& videoPreview = videoRtp->getVideoLocal()) {
            ...
            StreamData previewStreamData {getCallId(), false, StreamType::video, getAccountId()};
        ...
        if (auto& videoReceive = videoRtp->getVideoReceive()) {
            ...
            StreamData receiveStreamData {getCallId(), true, StreamType::video, getAccountId()};
