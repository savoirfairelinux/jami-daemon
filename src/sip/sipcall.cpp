...
SIPCall::startAllMedia()
{
    ...
    // TODO. It's very late to fail the call here if the security
    // setting do not match. Should fail the call when the transport
    // is set (in SIPCall::setTransport()).
