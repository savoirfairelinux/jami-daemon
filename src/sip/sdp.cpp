...
{
    //~ [jn] b sdp.cpp:416
    //~ if (createLocalSession(selectedAudioCodecs, isAudioOnly ? selectedVideoCodecs : std::vector<std::shared_ptr<AccountCodecInfo>>(), security, holding, isAudioOnly) != PJ_SUCCESS) {
