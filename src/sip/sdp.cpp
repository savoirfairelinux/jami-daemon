...
{
    if (mediaDirectionCb_) {
        return DIRECTION_STR[mediaDirectionCb_(mediaAttr)];
    }
    return DIRECTION_STR[MediaDirection::UNKNOWN];
}
...
void
Sdp::setMediaDirectionCb(DirectionCb&& dirCb)
{
    mediaDirectionCb_ = std::move(dirCb);
}
