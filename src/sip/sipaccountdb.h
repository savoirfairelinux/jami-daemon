#ifndef SIPACCOUNTDB_H
#define SIPACCOUNTDB_H
 ...
 */
class SIPAccountDB : public SIPAccountBase {
    public:
         ...
         */
        SIPAccountDB(const std::string& accountID);
    ...
    protected:
        ...
        virtual void doRegisterIPToIP();
        NON_COPYABLE(SIPAccountDB);
