...
namespace Migration {
    ...
    std::string
    mapStateNumberToString(const Migration::State migrationState)
    {
    ...
    setMigrationState (const std::string& accountID,
                       const Migration::State migrationState)
    {
...
RingAccount::migrateAccount(const std::string& pwd)
{
    ...
    if (updateCertificates(archive, identity_)) {
        ...
        Migration::setMigrationState(accountID_, Migration::State::SUCCESS);
    }
    Migration::setMigrationState(accountID_, Migration::State::INVALID);
}
