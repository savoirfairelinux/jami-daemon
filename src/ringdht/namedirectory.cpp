...
void NameDirectory::addrLookup(const std::string& addr, LookupCallback cb)
{
    ...
    restbed::Http::async(req, [this,cb,addr](const std::shared_ptr<restbed::Request>, const std::shared_ptr<restbed::Response> reply) {
...
void NameDirectory::nameLookup(const std::string& name, LookupCallback cb)
{
    ...
    restbed::Http::async(request, [this,cb,name](const std::shared_ptr<restbed::Request>, const std::shared_ptr<restbed::Response> reply) {
