    ...
    void connectRelay(const IpAddr& relay) {
        ...
        relayConnect_ = std::async(std::launch::async, [this] {
                ...
                try {
                    ...
                    endpoint_->writeline(hello_packet, sizeof hello_packet);
                    ...
                    if (!std::equal(&answer[0], &answer[answer.size()],
                                    &hello_answer_packet[0]))
    ...
    void onPeerConnection(uint32_t conn_id, const IpAddr& peer_addr) {
        ...
        peerHello_ = std::async(std::launch::async, [this] {
                ...
                try {
                    ...
                    turn_->writelineto(peerAddr_, hello_answer_packet, sizeof hello_answer_packet);
                    ready();
                } catch (const std::exception& e) {
