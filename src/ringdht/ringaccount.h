...
class RingAccount : public SIPAccountBase {
    ...
    private:
         ...
         * @param account_id  The account id;
         */
        void trackedAccountIsOffline(const dht::InfoHash& account_id);
        ...
        std::map<dht::InfoHash, std::map<dht::InfoHash, std::chrono::steady_clock::time_point>> trackedAccountsIDs_;
