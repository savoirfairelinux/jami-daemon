...
class RingAccount : public SIPAccountBase {
    ...
    private:
        ...
        void onIncomingIceDataMsg(dht::IceCandidates&& msg);
        ...
        void onDataIceInitComplete(const std::string& peer_id);
        ...
        void cancelPendingTransaction(const std::string& peer_id);

        std::mutex dataMutex_;
        std::list<dht::IceCandidates> pendingDataRequests_;
