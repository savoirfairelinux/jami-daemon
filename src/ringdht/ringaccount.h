...
class RingAccount : public SIPAccountBase {
    ...
    private:
        ...
        void onDataIceInitComplete(IceTransport& ice, dht::IceCandidates&& remote_ice, bool initiator);
        void onDataIceNegoComplete(IceTransport& ice, const std::string& peer);
