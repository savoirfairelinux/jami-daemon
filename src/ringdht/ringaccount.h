...
class RingAccount : public SIPAccountBase {
    ...
    private:
         ...
         */
        void onTrackedBuddyOffline(std::shared_ptr<RingAccount> sthis, std::map<dht::InfoHash, BuddyInfo>::iterator& buddy_info_it);
         ...
         */
        void onTrackedBuddyOnline(std::shared_ptr<RingAccount> sthis, std::map<dht::InfoHash, BuddyInfo>::iterator& buddy_info_it, const dht::InfoHash& device_id);
