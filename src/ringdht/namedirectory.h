...
public:
    ...
    enum class Response : int { found = 0, notFound, error };
    enum class RegistrationResponse { success, alreadyTaken, error };
    ...
    void registerName(const std::string& addr, const std::string& name, RegistrationCallback cb);
