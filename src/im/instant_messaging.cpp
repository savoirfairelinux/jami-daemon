...
void
InstantMessaging::send_sip_message(pjsip_inv_session* session, const std::string& id,
...
#if HAVE_IAX
void
InstantMessaging::send_iax_message(iax_session *session, const std::string &/* id */,
                                   const std::vector<std::string>& chunks)
{
