...
public:
     ...
     * @param callId
     */
    bool answerCall(const std::string& accountId, const std::string& callId, const std::vector<DRing::MediaMap>& mediaList = {});
    ...
    bool hangupConference(Conference& conference);
