...
public:
    ...
    /**
     * Answer a media update request
     * @param callId
     * @param mediaList the list of media attributes. The client can
     * control the media through the attributes. The list should be of
     * the same size as the list reported in the media update request.
     * The client can ignore the media update request by not calling thi
