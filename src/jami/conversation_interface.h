...
// Calls
DRING_PUBLIC std::vector<std::map<std::string, std::string>> getActiveCalls(
...
DRING_PUBLIC std::map<std::string, std::string> getConversationPreferences(const std::string& accountId,
                                                                  const std::string& conversationId);
