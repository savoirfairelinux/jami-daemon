...
// KESS TODO add API for piping credentials into newDev
LIBJAMI_PUBLIC bool authenticateAccount(const std::string& accountId, const std::string& passwordFromUser, const std::string& scheme);
