...
LIBJAMI_PUBLIC bool provideAccountAuthentication(const std::string& accountId, const std::string& credentialsFromUser, const std::string& scheme);

LIBJAMI_PUBLIC uint32_t addDevice(const std::string& accountId, const std::string& uri);
LIBJAMI_PUBLIC bool confirmAddDevice(const std::string& accountId, uint32_t op_id, uint32_t action);
