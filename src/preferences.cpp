...
AudioPreference::AudioPreference()
    ...
    , alsaCarjami_(atoi(ALSA_DFT_CARD))
    , alsaPlugin_("default")
    , alsaSmplrate_(44100)
...
AudioPreference::createAudioLayer()
{
    ...
    checkSoundCard(alsaCarjami_, AudioDeviceType::RINGTONE);
...
AudioPreference::serialize(YAML::Emitter& out) const
{
    ...
    out << YAML::Key << CARDRING_KEY << YAML::Value << alsaCarjami_;
...
AudioPreference::unserialize(const YAML::Node& in)
{
    ...
    parseValue(alsa, CARDRING_KEY, alsaCarjami_);
