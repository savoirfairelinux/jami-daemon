...
struct CommitMessage
{
    ...
    //
    // File transfers can optionally include a "reply-to" field with the ID of the message being
    // replied to, e.g.:
    //
    //     {"displayName":"aang.jpg","reply-to":"160e330e417401ecdd11094a8dad1355bd734583","sha3sum":"cae439cabde1dd86e15210f1f1486e7bbe0b901e9cb40d087b9673b7827ac5c9b2bf3d5fa3872666d418f205e986e8afa9977ddaba5e4141bdb157fd754656c2","tid":"693561489759880","totalSize":"89040","type":"application/data-transfer+json"}
    //
    ...
    static CommitMessage initial(ConversationMode mode, const std::string& invitedId = "")
    {
        CommitMessage msg;
