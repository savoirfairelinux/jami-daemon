...
JamiAccountConfig::unserialize(const YAML::Node& node)
{
    ...
    parsePath(tlsMap, Conf::CERTIFICATE_KEY, tlsCertificateFile, basePath);
    parsePath(tlsMap, Conf::CALIST_KEY, tlsCaListFile, basePath);
    parseValueOptional(tlsMap, Conf::TLS_PASSWORD_KEY, tlsPassword);
    parsePath(tlsMap, Conf::PRIVATE_KEY_KEY, tlsPrivateKeyFile, basePath);*/
