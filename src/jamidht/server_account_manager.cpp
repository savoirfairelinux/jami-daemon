...
constexpr auto PATH_LOGIN = sstr::literal("/api/login");
constexpr auto PATH_AUTH = sstr::literal("/api/auth");
constexpr auto PATH_DEVICE = PATH_AUTH + "/device";
constexpr auto PATH_DEVICES = PATH_AUTH + "/devices";
constexpr auto PATH_SEARCH = PATH_AUTH + "/directory/search";
constexpr auto PATH_CONTACTS = PATH_AUTH + "/contacts";
