...
public:
    ...
    bool provideAccountAuthentication2(const std::string& credentialsFromUser, const std::string_view scheme); // new link device
...
private:
    ...
    std::weak_ptr<dhtnet::ChannelSocketInterface> authChannel_; // for sending credentials from client
