...
public:
    ...
    void transferFile(const std::string& conversationId, const std::string& path, const std::string& deviceId, DRing::DataTransferId tid);
    /**
     ...
     */
    void downloadFile(const std::string& conversationUri,
