...
CollabChannelHandler::CollabChannelHandler(const std::shared_ptr<JamiAccount>& acc,
                            ...
                            std::string& documentId)
{
    ...
    return !deviceId.empty() && CollabRepository::isValidId(conversationId)
           && CollabRepository::isValidId(documentId);
}
...
bool
CollabChannelHandler::onRequest(const std::shared_ptr<dht::crypto::Certificate>& cert,
