...
void
ArchiveAccountManager::startSync(const OnNewDeviceCb& cb, const OnDeviceAnnouncedCb& dcb, bool noPresencePut)
{
    AccountManager::startSync(std::move(cb), std::move(dcb), noPresencePut);
