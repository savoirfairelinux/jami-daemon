...
void
ArchiveAccountManager::migrateAccount(AuthContext& ctx/*const std::string& pwd, dht::crypto::Identity& device*/)
{
    ...
    try {
        ...
        //return AuthError::INVALID_ARGUMENTS;
    ...
    if (updateCertificates(archive, ctx.credentials->updateIdentity)) {
        ...
        //saveArchive(archive, ctx.credentials->password);
