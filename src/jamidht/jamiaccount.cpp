...
bool
JamiAccount::provideAccountAuthentication(const std::string& credentialsFromUser, std::string_view scheme)
{
...
// >>>>>>> 808e24a98 ((WIP) ArchiveAccountManager: add support for p2p)
            ...
            JAMI_WARNING("[Account {}] initAuthentication {} {}", getAccountID(), fmt::ptr(this), fmt::ptr(accountManager_));
