...
{
    upnp_->requestMappingAdd(std::bind(&JamiAccount::onPortMappingAdded, this, _1, _2),
                             dhtPort_, jami::upnp::PortType::UDP, false);
}

void
JamiAccount::onPortMappingAdded(uint16_t port_used, bool success)
{
...
JamiAccount::doRegister()
{
    ...
    if (upnp_) {
        JAMI_DBG("UPnP: Attempting to map ports for RING account");
