...
JamiAccount::serialize(YAML::Emitter& out) const
{
    ...
    out << YAML::BeginMap;
    stunEnabled_ = connectionManagerConfig_->stunEnabled_;
    stunServer_ = connectionManagerConfig_->stunServer_;
    turnServer_ = connectionManagerConfig_->turnServer_;
    turnServerUserName_ = connectionManagerConfig_->turnServerUserName_;
    turnServerPwd_ = connectionManagerConfig_->turnServerPwd_;
    turnServerRealm_ = connectionManagerConfig_->turnServerRealm_;
    turnEnabled_ = connectionManagerConfig_->turnEnabled_;
