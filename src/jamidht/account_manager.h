...
private:
    ...
    void loadFromFile(const std::shared_ptr<AuthContext>& ctx, const std::string& archive_path, const std::string& archive_password);
    void loadFromDHT(const std::shared_ptr<AuthContext>& ctx, const std::string& archive_password, const std::string& archive_pin);
