...
// TODO avoid duplicate with sips
static void
...
ChanneledSIPTransport::ChanneledSIPTransport(pjsip_endpoint* endpt, int tp_type, const std::shared_ptr<ChannelSocket>& socket,
...
uint16_t
ChanneledSIPTransport::getTlsSessionMtu()
{
    return 65536 /* TODO */;
}
