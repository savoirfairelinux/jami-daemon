...
#include "src/jamidht/channel_handler.h"
#include "src/jamidht/connectionmanager.h"
 ...
 */
class ConversationChannelHandler : public ChannelHandler
{
public:
    ConversationChannelHandler(ConnectionManager& cm);
...
private:
    ConnectionManager& connectionManager_; // TODO resetted?
};
