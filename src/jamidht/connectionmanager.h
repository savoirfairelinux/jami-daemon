...
public:
    ...
    std::shared_ptr<ChannelSocket> addChannel(const std::string uri);
...
public:
    ...
    ChannelSocket(MultiplexedSocket& endpoint, const std::string& uri);
    std::string deviceId() const;
