...
/**
 * Used to accept or decline an incoming connection
 */
using PeerRequestCallBack = std::function<bool(const std::string& /* deviceId */, const std::string& /* name (empty for control) */)>;
/**
