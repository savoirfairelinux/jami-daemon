...
public:
    ...
    /**
     * Validate a clone
     * @return the validated commits and false if an error occurs
     */
     ...
     * @param commitsToValidate     the list of commits
     */
...
private:
    ...
    static std::unique_ptr<ConversationRepository> create_repository(const std::shared_ptr<JamiAccount>& account,
