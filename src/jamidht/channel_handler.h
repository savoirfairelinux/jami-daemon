...
#include "src/jamidht/multiplexed_socket.h" // TODO sha1

namespace jami {

using ConnectCb = std::function<void(std::shared_ptr<ChannelSocket> socket)>;
...
public:
     ...
     */
    virtual void connect(const DeviceId& deviceId, ConnectCb&& cb) = 0;
