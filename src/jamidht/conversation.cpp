...
public:
    ...
    void init()
    {
        if (auto shared = account_.lock()) {
            ...
            swarmManager_->onDisconnected([&] {
                // TODO: iterate on members (randomly organized) to find someone present
                // and try again
                // If nobody - stop bootstraping. Other will try to contact us later.
                JAMI_ERR("@@@");
...
Conversation::bootstrap()
{
    ...
    JAMI_ERROR("@@@ bootstrap with {} devices", devices.size());
