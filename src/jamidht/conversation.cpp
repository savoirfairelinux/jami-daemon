...
public:
    ...
    std::optional<std::map<std::string, std::string>> convCommitToMap(
        ...
        const std::vector<std::map<std::string, std::string>> loadMessages(
            const std::string& fromMessage = "", const std::string& toMessage = "", size_t n = 0);
...
Conversation::getCommit(const std::string& commitId)
{
