...
public:
     ...
     */
    std::vector<std::string> getHandlers();
     ...
     */
    std::map<std::string, std::string> getHandlerDetails(const std::string& preferenceHandlerIdStr);
     ...
     * @param rootPath
     */
    void resetPreferences(const std::string& accountId, const std::string& rootPath);
