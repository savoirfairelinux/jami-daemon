...
std::string
PluginPreferencesUtils::getAllowDenyListsPath(bool allow)
{
    if (allow)
...
void
PluginPreferencesUtils::setAllowDenyListPreferences(const ChatHandlerList& list, bool allow) {
...
void
PluginPreferencesUtils::getAllowDenyListPreferences(ChatHandlerList& list, bool allow) {
