...
PreferenceServicesManager::getHandlerDetails(const std::string& preferenceHandlerIdStr)
{
...
void
PreferenceServicesManager::resetPreferences(const std::string& accountId,
                                            const std::string& rootPath)
{
    for (auto& preferenceHandler : handlers_) {
        if (preferenceHandler->id().find(rootPath) != std::string::npos) {
