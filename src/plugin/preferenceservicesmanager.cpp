...
PreferenceServicesManager::getHandlers()
{
...
PreferenceServicesManager::getHandlerDetails(
...
bool
PreferenceServicesManager::setPreference(const std::string& accountId,
...
PreferenceServicesManager::registerComponentsLifeCycleManagers(PluginManager& pluginManager)
{
    ...
    auto registerHandler = [this](void* data, std::mutex& pmMtx_) {
        ...
        // Adding preference that tells us to automatically activate a PreferenceHandler.
        PluginPreferencesUtils::addAlwaysHandlerPreference(ptr->getHandlerDetails().at(
                                                               "name"),
