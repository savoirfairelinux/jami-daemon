...
{
    return PluginPreferencesManager::getPreferences(rootPath);
}

std::map<std::string, std::string>
JamiPluginManager::getPluginUserPreferencesValuesMap(const std::string& rootPath)
{
    return PluginPreferencesManager::getUserPreferencesValuesMap(rootPath);
}
                                       ...
                                       const std::string& value)
{
    std::map<std::string, std::string> pluginUserPreferencesMap
        = PluginPreferencesManager::getUserPreferencesValuesMap(rootPath);
    std::map<std::string, std::string> pluginPreferencesMap = PluginPreferencesManager::getPreferencesValuesMap(
        rootPath);

    auto find = pluginPreferencesMap.find(key);
    if (find != pluginPreferencesMap.end()) {
        std::vector<std::map<std::string, std::string>> preferences = PluginPreferencesManager::getPreferences(
            rootPath);
        ...
        const std::string preferencesValuesFilePath = PluginPreferencesManager::valuesFilePath(
            rootPath);
...
{
    return PluginPreferencesManager::getPreferencesValuesMap(rootPath);
}

bool
JamiPluginManager::resetPluginPreferencesValuesMap(const std::string& rootPath)
{
    return PluginPreferencesManager::resetPreferencesValuesMap(rootPath);
}
