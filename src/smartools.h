 ...
 */
 ...
 class Smartools{
    public:
      ...
      static void setLocalVideoCodec(const std::string& localVideoCodec);
      static void setRemoteVideoCodec(const std::string& remoteVideoCodec, const std::string& callID);
      static void setRemoteAudioCodec(const std::string& remoteAudioCodec);
    ...
    private:
      ...
      static std::map<std::string, std::string> frameRate_;
      static std::string remoteResolution_;
      static std::string localVideoCodec_;
      static std::string remoteVideoCodec_;
      static std::string remoteAudioCodec_;
      static std::string callID_;
