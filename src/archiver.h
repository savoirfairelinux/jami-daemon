...
public:
     ...
     * @param toFile The filepath where to put the resulting archive
...
private:
    ...
    std::map<std::string, std::string> jsonValueToAccount(Json::Value& value, const std::string& accountId);
};
