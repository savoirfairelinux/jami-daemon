 ...
 */
long uncompressArchive(const std::string& path, const std::string &dir, const FileMatchPair& f);
 ...
 */
std::vector<uint8_t> readFileFromArchiveToStream(const std::string &path,
