...
bool
dataConnectionInfo(const DataConnectionId& id, const DataConnectionInfo& info)
{
    return false;
}

bool
closeDataConnection(const DataConnectionId& id)
{
    return false;
}
...
bool
dataTransferInfo(const DataTransferId& id, DataTransferInfo& info)
{
    return false;
}
