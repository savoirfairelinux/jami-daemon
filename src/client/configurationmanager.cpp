...
void
sendAccountTextMessage(const std::string& accountID, const std::string& to, const std::map<std::string, std::string>& messages)
{
    ring::Manager::instance().sendTextMessage(accountID, to, messages);
}
