...
public:
    ...
    /**
     * Disconnect local audio/video from the conference
     */
    void disconnectHost();
    ...
    /**
     * Return the last media list before the host was disconnected
...
private:
    ...
    // Last media list before disconnecting from a conference
