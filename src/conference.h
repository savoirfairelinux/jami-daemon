...
// Actions that can be performed by all participants
static constexpr const char* CONF_RAISE_HAND = "raiseHand";
static constexpr const char* CONF_DOWN_HAND = "downHand";
