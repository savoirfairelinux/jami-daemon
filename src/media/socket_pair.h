...
#error Define one of RTP_LITTLE_ENDIAN or RTP_BIG_ENDIAN
        ...
        unsigned totalMarkedFrameSend_ = 0;
        uint32_t current_ssrcSend_ = 0;
        unsigned firstSessionSeqSend_ = 0;
        unsigned lastSessionSeqSend_ = 0;

        unsigned totalMarkedFrameReceive_ = 0;
        uint32_t current_ssrcReceive_ = 0;
        unsigned firstSessionSeqReceive_ = 0;
        unsigned lastSessionSeqReceive_ = 0;
