...
HardwareAccel::setupDecoder(AVCodecID id, int width, int height)
{
    static const HardwareAPI apiList[] = {
        ...
        { "qsv", AV_PIX_FMT_QSV, AV_PIX_FMT_NV12, { AV_CODEC_ID_H264, AV_CODEC_ID_H265, AV_CODEC_ID_MJPEG, AV_CODEC_ID_VP9, AV_CODEC_ID_VC1 } },
	};
...
HardwareAccel::setupEncoder(AVCodecID id, int width, int height, AVBufferRef* framesCtx)
{
    static const HardwareAPI apiList[] = {
        ...
        { "qsv", AV_PIX_FMT_QSV, AV_PIX_FMT_NV12, { AV_CODEC_ID_H264, AV_CODEC_ID_H265, AV_CODEC_ID_MJPEG } },
	};
