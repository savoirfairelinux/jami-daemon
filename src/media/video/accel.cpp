...
{
    const HardwareAccel accels[] = {
        { "omx", false, AV_PIX_FMT_YUV420P, { AV_CODEC_ID_H264 } },
        { "vaapi", true, AV_PIX_FMT_VAAPI, { AV_CODEC_ID_H264, AV_CODEC_ID_HEVC, AV_CODEC_ID_MJPEG, AV_CODEC_ID_VP8, AV_CODEC_ID_VP9 } },
        { "videotoolbox", true, AV_PIX_FMT_VIDEOTOOLBOX, { AV_CODEC_ID_H264, AV_CODEC_ID_MPEG4, AV_CODEC_ID_H263, AV_CODEC_ID_HEVC } },
    };
    for (auto accel : accels) {
        if (std::find(accel.supportedCodecs.begin(), accel.supportedCodecs.end(),
                static_cast<AVCodecID>((*codecCtx)->codec_id)) != accel.supportedCodecs.end()) {
