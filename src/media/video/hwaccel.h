...
class HardwareAccel {
    public:
        ...
        virtual void init() = 0;
        virtual void getBuffer(AVFrame* frame, int flags) = 0;
...
class HardwareAccelContext {
    ...
    private:
        ...
        static map<std::string, HardwareAccelCreator> hardwareAccelMap_ = {
#if HAVE_VAAPI_DRM || HAVE_VAAPI_X11
            { 'vaapi', make<VaapiAccel> }
#endif
        }
