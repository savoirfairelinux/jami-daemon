...
{
    unsigned int ret = 4.5 * localVideoParams_.height + (localVideoParams_.framerate.numerator() / localVideoParams_.framerate.denominator() * 50 - 1500);
    // 480p   30fps -> 2160 kbps
    // 720p   30fps -> 3240 kbps
    // 720p   60fps -> 4740 kbps
