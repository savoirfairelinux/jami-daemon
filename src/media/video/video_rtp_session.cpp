...
VideoRtpSession::setupVideoBitrateInfo() {
    ...
    if (codecVideo) {
        ...
        videoBitrateInfo_.videoBitrateCurrent = videoBitrateInfo_.videoBitrateMin + (videoBitrateInfo_.videoBitrateMax - videoBitrateInfo_.videoBitrateMin) * (Manager::instance().getBitrate() / 100);
