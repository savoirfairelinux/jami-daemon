                   ...
                   const std::shared_ptr<MediaFrame>& frame_p)
{
    ...
    if (doTransfer) {
#ifdef RING_ACCEL
        std::shared_ptr<VideoFrame> frame {transferToMainMemory(*std::static_pointer_cast<VideoFrame>(frame_p), AV_PIX_FMT_NV12)};
#else
        std::shared_ptr<VideoFrame> frame {frame_p};
#endif
