 ...
 *
 * For complex filters, it is advised to name each filter graph input. These names are used to feed the filter.
 * This is not required for simple filters, as there is only one possibility.
 *
 * Example: "[in1] scale=iw/4:ih/4 [mid]; [in2] [mid] overlay=main_w-overlay_w-10:main_h-overlay_h-10"
