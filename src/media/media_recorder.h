...
private:
    ...
    std::mutex mutexVideo_;
    std::mutex mutexAudio_;
    ...
    void filterAndEncodeVideo(int streamIdx);
    void filterAndEncodeAudio(int streamIdx);

    std::condition_variable cvAudio_;
    std::condition_variable cvVideo_;
