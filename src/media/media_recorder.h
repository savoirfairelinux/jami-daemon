...
class MediaRecorder {
    public:
        ...
        /* FIXME setRecordingPath is deprecated. */
        ...
        int startRecording(std::string path = "");
    ...
    private:
        ...
        /* FIXME dir_ and filename_ are deprecated. dir_ was set by
           setRecordingPath() which had to be called before startRecording(),
           and filename_ was initialized by startRecording(). Path should now
           be passed to startRecording(). */
        std::string path_{""};
        std::string dir_;
