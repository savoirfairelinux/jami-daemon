...
constexpr static char TRUE_VAL[] = "true";
constexpr static char FALSE_VAL[] = "false";
constexpr static char AUDIO[] = "audio";
constexpr static char VIDEO[] = "video";
} // namespace MediaAttributeValue
