...
int
MediaFilter::initializeFilters(AVCodecContext* codecCtx, const std::string filterChain)
{
    clean();
    ...
    RING_DBG() << "Filter chain initialized: " << filterChain_;
