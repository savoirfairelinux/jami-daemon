...
MediaPlayer::initMediaInputs()
{
    ...
    videoInput_ =
    std::static_pointer_cast<video::VideoInput>
    (jami::getVideoInput(path_,
    ...
    double duration = audioInput_->duration();
    auto base = AV_TIME_BASE;
    double res = duration / base;
    emitSignal<DRing::MediaPlayerSignal::FileOpened>(playerId_, res);
}
