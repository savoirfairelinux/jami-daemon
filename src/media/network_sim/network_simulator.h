...
public:
     ...
     * Stored for use by getJitter()/randomJitter() helpers.
     * Note: shouldSend() does NOT inject delay — use tc/netem for
     * realistic network jitter simulation on the link layer.
     * 0 = no jitter configured.
     */
