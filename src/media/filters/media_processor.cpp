    ...
    , lastOutput_(nullptr)
{
    t = std::thread([this] {
        ...
        while (running) {
            ...
            //cout <<"in t rects size " <<  lastOutput_->rects.size() << endl;
            //cout <<"in t labels size " <<  lastOutput_->labels.size() << endl;
            //cout <<"in t confidence size " <<  lastOutput_->confidence.size() << endl;
            //cout <<"in t label " <<  lastOutput_->labels[0] << endl;
            //cout <<"in t confidence " <<  lastOutput_->confidence[0] << endl;
