...
MediaEncoder::getFullpipelineFrame(const std::shared_ptr<VideoFrame>& input)
{
    return input;
}
...
std::shared_ptr<VideoFrame>
MediaEncoder::getHWFrameFromSWFrame(const std::shared_ptr<VideoFrame>& input)
{
...
std::shared_ptr<VideoFrame>
MediaEncoder::getScaledSWFrame(const std::shared_ptr<VideoFrame>& input)
{
