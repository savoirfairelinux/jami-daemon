...
int
MediaEncoder::getHWFrame(VideoFrame& input, std::shared_ptr<VideoFrame>* output)
{
    try {
#if defined(TARGET_OS_IOS) && TARGET_OS_IOS
// iOS
...
MediaEncoder::getFullpipelineFrame(VideoFrame& input)
{
...
std::shared_ptr<VideoFrame>
MediaEncoder::getUnlinkedHWFrame(VideoFrame& input)
{
...
std::shared_ptr<VideoFrame>
MediaEncoder::getHWFrameFromSWFrame(VideoFrame& input)
{
...
std::shared_ptr<VideoFrame>
MediaEncoder::getScaledSWFrame(VideoFrame& input)
{
