...
#define WAV_LOG_INPUT_START(frame) \
    jami::DebugAudioCapture::instance().captureFrame(jami::AudioTracePoint::INPUT_START, frame, __FUNCTION__)

#define WAV_LOG_INPUT_CAP(frame) \
    jami::DebugAudioCapture::instance().captureFrame(jami::AudioTracePoint::INPUT_CAP, frame, __FUNCTION__)

#define WAV_LOG_RESAMPLER_IN(frame) \
    jami::DebugAudioCapture::instance().captureFrame(jami::AudioTracePoint::RESAMPLER_IN, frame, __FUNCTION__)

#define WAV_LOG_RESAMPLER_OUT(frame) \
    jami::DebugAudioCapture::instance().captureFrame(jami::AudioTracePoint::RESAMPLER_OUT, frame, __FUNCTION__)

#define WAV_LOG_PROCESSOR_IN(frame) \
    jami::DebugAudioCapture::instance().captureFrame(jami::AudioTracePoint::PROCESSOR_IN, frame, __FUNCTION__)

#define WAV_LOG_PROCESSOR_OUT(frame) \
    jami::DebugAudioCapture::instance().captureFrame(jami::AudioTracePoint::PROCESSOR_OUT, frame, __FUNCTION__)

#define WAV_LOG_OUTPUT_START(frame) \
    jami::DebugAudioCapture::instance().captureFrame(jami::AudioTracePoint::OUTPUT_START, frame, __FUNCTION__)

#define WAV_LOG_OUTPUT_RENDER(frame) \
    jami::DebugAudioCapture::instance().captureFrame(jami::AudioTracePoint::OUTPUT_RENDER, frame, __FUNCTION__)

// Control macros
#define WAV_LOG_START_CAPTURE(point, sessionId) \
    jami::DebugAudioCapture::instance().startCapture(point, sessionId)

#define WAV_LOG_STOP_CAPTURE(point) \
    jami::DebugAudioCapture::instance().stopCapture(point)

#define WAV_LOG_EXPORT_ALL(prefix) \
    jami::DebugAudioCapture::instance().exportAllToWav(prefix)
