...
public:
    ...
    /**
     * Sets the format used by @queue_. This drains the queue, all stored samples will
     * be lost.
     */
    ...
    /**
     * Reads @nbSamples from the queue into a frame and returns it.
     *
     * Returns a valid audio frame, or null if there wasn't enough data.
     */
