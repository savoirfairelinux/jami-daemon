...
// TODO: decide which library to use/prioritize
#if HAVE_WEBRTC_AP
...
AudioLayer::createAudioProcessor()
{
    ...
    // we are using speex
    // TODO: force this to be equivalent to 20ms? as expected by speex
    ...
    // TODO: enable audio processor features
    audioProcessor->enableNoiseSuppression(false);
