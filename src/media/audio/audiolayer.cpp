...
AudioLayer::AudioLayer(const AudioPreference& pref)
    ...
    , echoCanceller(pref.getEchoCanceller())
...
AudioLayer::setHasNativeAEC(bool hasNativeAEC)
{
    ...
    if (audioProcessor) {
        audioProcessor->enableEchoCancel(
            shouldUseAudioProcessorEchoCancel(hasNativeAEC, echoCanceller));
    }
}
...
AudioLayer::createAudioProcessor()
{
    ...
    audioProcessor->enableEchoCancel(
        shouldUseAudioProcessorEchoCancel(hasNativeAEC_, echoCanceller));
