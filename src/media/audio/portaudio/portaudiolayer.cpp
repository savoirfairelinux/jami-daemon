...
static void
openStreamDevice(PaStream** stream, PaDeviceIndex device, Direction direction,
                 PaStreamCallback* callback, void* user_data)
{
    ...
    params.channelCount = direction == Direction::Output ? device_info->maxOutputChannels : device_info->maxInputChannels;
    params.sampleFormat = paInt16;
    params.suggestedLatency = direction == Direction::Output ? device_info->defaultLowOutputLatency: device_info->defaultLowInputLatency;
