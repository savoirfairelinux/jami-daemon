...
static void
openStreamDevice(PaStream** stream, AudioFormat& nb_channels,
                 ...
                 PaStreamCallback* callback, void* user_data)
{
    ...
    params.channelCount = nb_channels = direction == Direction::Output ? device_info->maxOutputChannels : device_info->maxInputChannels;
