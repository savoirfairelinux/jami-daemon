...
{
    tones_[Tone::TONE_DIALTONE] = std::move(Tone(toneZone[countryId_][Tone::TONE_DIALTONE], sampleRate));
    tones_[Tone::TONE_BUSY] = std::move(Tone(toneZone[countryId_][Tone::TONE_BUSY], sampleRate));
    tones_[Tone::TONE_RINGTONE] = std::move(Tone(toneZone[countryId_][Tone::TONE_RINGTONE], sampleRate));
    tones_[Tone::TONE_CONGESTION] = std::move(Tone(toneZone[countryId_][Tone::TONE_CONGESTION], sampleRate));
}
