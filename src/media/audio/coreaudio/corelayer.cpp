...
CoreLayer::getCaptureDeviceList() const
{
    ...
    ret.assign({"built_in_mic", "bluetooth", "headphones"});
#endif
...
CoreLayer::setupOutputBus() {
    ...
    outputASBD.mFormatFlags = kAudioFormatFlagsAudioUnitCanonical;
#else
...
CoreLayer::startStream()
{
    ...
    checkErr(AudioUnitGetProperty(ioUnit_,
                                  ...
                                  &outputASBD,
                                  &size));
    RING_WARN("O-kAudioUnitScope_Input: { mSampleRate: %0.2f, mFormatID: %ld, mFormatFlags: %d, mBytesPerPacket: %d, mBytesPerFrame: %d, mBitsPerChannel %d }",
              outputASBD.mSampleRate, outputASBD.mFormatID, outputASBD.mFormatFlags, outputASBD.mBytesPerPacket, outputASBD.mBytesPerFrame, outputASBD.mBitsPerChannel);
    ...
    checkErr(AudioUnitGetProperty(ioUnit_,
                                  ...
                                  &outputASBD,
                                  &size));
    RING_WARN("O-kAudioUnitScope_Output: { mSampleRate: %0.2f, mFormatID: %ld, mFormatFlags: %d, mBytesPerPacket: %d, mBytesPerFrame: %d, mBitsPerChannel %d }",
              outputASBD.mSampleRate, outputASBD.mFormatID, outputASBD.mFormatFlags, outputASBD.mBytesPerPacket, outputASBD.mBytesPerFrame, outputASBD.mBitsPerChannel);
    ...
    checkErr(AudioUnitGetProperty(ioUnit_,
                                  ...
                                  &inputASBD,
                                  &size));
    RING_WARN("I-kAudioUnitScope_Input: { mSampleRate: %0.2f, mFormatID: %ld, mFormatFlags: %d, mBytesPerPacket: %d, mBytesPerFrame: %d, mBitsPerChannel %d }",
              inputASBD.mSampleRate, inputASBD.mFormatID, inputASBD.mFormatFlags, inputASBD.mBytesPerPacket, inputASBD.mBytesPerFrame, inputASBD.mBitsPerChannel);
    ...
    checkErr(AudioUnitGetProperty(ioUnit_,
                                  ...
                                  &inputASBD,
                                  &size));
    RING_WARN("I-kAudioUnitScope_Output: { mSampleRate: %0.2f, mFormatID: %ld, mFormatFlags: %d, mBytesPerPacket: %d, mBytesPerFrame: %d, mBitsPerChannel %d }",
              inputASBD.mSampleRate, inputASBD.mFormatID, inputASBD.mFormatFlags, inputASBD.mBytesPerPacket, inputASBD.mBytesPerFrame, inputASBD.mBitsPerChannel);
}
...
CoreLayer::read(AudioUnitRenderActionFlags* ioActionFlags,
    ...
    AudioBufferList* ioData)
{
    //RING_WARN("inframes: %d", inNumberFrames);
