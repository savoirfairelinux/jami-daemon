...
CoreLayer::initAudioLayerIO()
{
    ...
    switch(indexOut_) {
        case 0:
            ...
            break;
        case 1:
            UInt32 setBluetoothInput;
            setBluetoothInput = 1;
            checkErr(AudioSessionSetProperty(kAudioSessionProperty_OverrideCategoryEnableBluetoothInput,
                                             sizeof (setBluetoothInput),
                                             &setBluetoothInput));
            CFStringRef audioRouteOverride;
            audioRouteOverride = kAudioSessionOutputRoute_BluetoothHFP;
...
CoreLayer::setupInputBus() {
    ...
    inputASBD.mFormatFlags = kAudioFormatFlagsAudioUnitCanonical;
