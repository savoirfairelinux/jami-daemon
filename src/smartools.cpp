...
#include "./manager.cpp"
 ...
 namespace ring {
   ...
   Smartools::process()
   {
     ...
     //info["CallID"]= Manager::getCurrentCallId();
     info["remoteFps"]= remoteFps_;
     info["localFps"]= localFps_;
     info["remoteResolution"]= remoteResolution_;
     info["localVideoCodec_"]= localVideoCodec_;
     info["remoteVideoCodec"]= remoteVideoCodec_;
     info["remoteAudioCodec"]= remoteAudioCodec_;
   ...
   void Smartools::setRemoteVideoCodec(const std::string& remoteVideoCodec){
