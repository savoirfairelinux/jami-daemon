...
#include "./manager.cpp"
 ...
 namespace ring {
   ...
   std::string Smartools::remoteCodec_ = "";
   ...
   void Smartools::setRemoteCodec(const std::string& remoteCodec){
     Smartools::remoteCodec_= remoteCodec;
   }
