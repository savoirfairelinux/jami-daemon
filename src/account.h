...
public:
    ...
    // Enable/disable component ID numbering compliancy to RFC-5245
    ...
    // The current version of the SDP parser is able to correctly parse both
    // versions. i.e., with or without enabling this feature.
    // This feature is needed for retro-compatiblity, and should be removed
    // when the retro-compatibility is no more required.
