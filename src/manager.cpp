...
struct Manager::ManagerPimpl
{
    ...
    std::map<uintptr_t, std::shared_ptr<RepeatedTask>> eventHandlerMap_;
...
{
    pimpl_->eventHandlerMap_[handlerId] = pimpl_->scheduler_.scheduleAtFixedRate([h = std::move(handler)]{
        h();
        return true;
