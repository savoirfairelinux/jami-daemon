...
Manager::ManagerPimpl::bindCallToConference(Call& call, Conference& conf)
{
    ...
    base_.getRingBufferPool().unBindAll(sip_utils::streamId(callId, "audio_0")); // TODO
...
Manager::addAudio(Call& call)
{
    ...
    if (call.isConferenceParticipant()) {
        ...
        // bind to main
        getRingBufferPool().bindRingbuffers(sip_utils::streamId(callId, "audio_0" /* TODO; look this up instead of hardcoding*/), RingBufferPool::AUDIO_LAYER_ID);
...
Manager::removeAudio(Call& call)
{
    ...
    getRingBufferPool().unBindAll(sip_utils::streamId(callId, "audio_0"));
