...
#ifndef DATADIR
#error "Define the DATADIR macro as the data installation prefix of the package"
#endif
...
Manager::playRingtone(const std::string& accountID)
{
    ...
    if (ringchoice.find(DIR_SEPARATOR_CH) == std::string::npos) {
        ...
        ringchoice = std::string(DATADIR) + DIR_SEPARATOR_STR + RINGDIR + DIR_SEPARATOR_STR
                     + ringchoice;
    }
