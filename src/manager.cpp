...
#undef PJSIP_TRY
	...
	dht::net::ConnectivityStatus::ConnectionEventCb cc_cb = [] (dht::net::ConnectivityStatus::Event ev) { DRing::connectivityChanged(ev); };
	if (pimpl_->connstat_)
	    pimpl_->connstat_->setEventListener(cc_cb, dht::net::ConnectivityStatus::Event::ADDR);
    } else
