...
{
    if (actions.isMember(CONF_HAND_UP)) {
        setHandRaised(actions[CONF_HAND_UP].asString(), true);
        actions.removeMember(CONF_HAND_UP);
        return;
    }
    if (actions.isMember(CONF_HAND_DOWN)) {
        setHandRaised(actions[CONF_HAND_DOWN].asString(), false);
        actions.removeMember(CONF_HAND_DOWN);
    }
}
