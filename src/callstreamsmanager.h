...
public:
    ...
    void setOnInfoUpdated(std::function<void(const std::vector<StreamInfo>& info)> onInfoUpdated) {
...
protected:
    ...
    std::function<void(const std::vector<StreamInfo>& info)> onInfoUpdated_;
    std::vector<StreamInfo> streamsInfo_;
};
