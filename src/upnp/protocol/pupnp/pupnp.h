...
private:
    ...
    constexpr static unsigned int SEARCH_TIMEOUT {30};              // Discovery search is 30 seconds.
    constexpr static unsigned int SUBSCRIBE_TIMEOUT {300};                                // Subscribtion timeout is 300 seconds (5 minutes).
