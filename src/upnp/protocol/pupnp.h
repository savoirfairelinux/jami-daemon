...
public:
    constexpr static unsigned SEARCH_TIMEOUT {30};          // 30 seconds.
    int SUBSCRIBE_TIMEOUT {300};                            // 300 seconds = 5 minutes.

    std::map<std::string, std::shared_ptr<IGD>> validIGDs_; // Map of valid IGDs with their UDN.
