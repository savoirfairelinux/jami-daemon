...
UPnPContext::removeMapping(const Mapping& mapping)
{
    ...
    for (auto const& item : igdList_) {
        ...
        if (mapping.getType() == PortType::UDP)
        ...
        auto mapToRemove = globalMappings->find(mapping.getPortExternal());
