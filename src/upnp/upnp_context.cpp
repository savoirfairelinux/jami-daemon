...
UPnPContext::UPnPContext()
{
	...
	pupnp_->setOnIgdChanged(std::bind(&UPnPContext::igdListChanged, this, _1, _2, _3, _4));
...
bool
UPnPContext::igdListChanged(UPnPProtocol* protocol, IGD* igd, const IpAddr publicIpAddr, bool added)
{
	if (added) {
