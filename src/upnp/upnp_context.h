...
public:
    ...
    void addCallback(Mapping map, ControllerData ctrlData);
    ...
    void requestMappingRemove(const Mapping& mapping);
...
private:
    ...
    void registerCallback(Mapping map, ControllerData ctrlData);
