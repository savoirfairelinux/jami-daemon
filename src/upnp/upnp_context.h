...
const constexpr auto IGD_SEARCH_TIMEOUT = std::chrono::seconds(1);
...
public:
    ...
    void requestMappingAdd(pControllerData ctrlData, uint16_t portDesired, uint16_t portLocal, PortType type, bool unique);
