...
public:
    ...
    using cbMapItr = std::map<Mapping*, pControllerData>::iterator;
    using pendingMapItr = std::vector<PendingMapRequest>::iterator;
...
private:
    ...
    std::mutex pendindRequestMutex_;
    std::vector<PendingMapRequest> pendingAddMapList_ {};
    std::vector<PendingMapRequest> pendingRmMapList_ {};
};
