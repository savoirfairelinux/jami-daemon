...
{
private:
    constexpr static auto MAP_REQUEST_TIMEOUT_UNIT = std::chrono::seconds(6);
    ...
    constexpr static uint16_t UPNP_TCP_PORT_MAX = UPNP_TCP_PORT_MIN + 50;
    constexpr static uint16_t UPNP_UDP_PORT_MIN = 20000;
    constexpr static uint16_t UPNP_UDP_PORT_MAX = UPNP_UDP_PORT_MIN + 50;
