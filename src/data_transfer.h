...
private: // Rx related members
    ...
    SeqNum::seqnum_t lastRxSeqNum_ {SeqNum::INVALID}; // largest seq# received
    SeqNum::seqnum_t lastRxAck_ {SeqNum::INVALID}; // largest ACK seq# received
...
private:
    std::atomic<unsigned> timeEXPCount_;
    std::chrono::microseconds timeRTT_;
    std::chrono::microseconds timeRTTVar_;
