...
{
public:
    bool popPacket(DataConnection::Packet&) { return false; };
};
...
public:
    ...
    void send(DataConnection::Packet&& pkt);

private:
    void threadJob();
    TxQueue::clock::time_point nextScheduleTimePoint();
    ...
    std::queue<std::shared_ptr<Sender>> senders_ {};
