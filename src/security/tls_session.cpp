                                       ...
                                       gnutls_x509_crt_t signer, OcspVerification cb)
{
    ...
    const std::string noncehex = bytes_to_hex_string(noncebuf, sizeof(noncebuf));
                                               ...
                                               gnutls_x509_crt_t signer, const std::string noncehex)
{
    ...
    // Debug {
    gnutls_datum_t dat;
    ret = gnutls_ocsp_resp_print(resp, GNUTLS_OCSP_PRINT_COMPACT /*_FULL*/, &dat);
    if (ret < 0) {
    ...
    if (!noncehex.empty()){
        ...
        const std::string rnoncehex = bytes_to_hex_string(rnonce.data, rnonce.size);
