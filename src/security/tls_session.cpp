...
static constexpr const char* TLS_CERT_PRIORITY_STRING {"SECURE192:+VERS-DTLS-ALL:-VERS-TLS-ALL:-RSA:%SERVER_PRECEDENCE:%SAFE_RENEGOTIATION"};
static constexpr const char* TLS_FULL_PRIORITY_STRING {"SECURE192:-KX-ALL:+ANON-ECDH:+ANON-DH:+SECURE192:+VERS-DTLS-ALL:-VERS-TLS-ALL:-RSA:%SERVER_PRECEDENCE:%SAFE_RENEGOTIATION"};
