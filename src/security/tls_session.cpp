...
static constexpr uint16_t HEARTBEAT_RETRANS_TIMEOUT = 200; // gnutls heartbeat retransmission timeout for each ping (in milliseconds)
static constexpr uint16_t HEARTBEAT_TOTAL_TIMEOUT = 400; // gnutls heartbeat time limit for heartbeat procedure (in milliseconds)
