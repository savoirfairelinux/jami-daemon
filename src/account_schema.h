...
static const char *const CONFIG_CONTACT_REWRITE_METHOD          = "Account.contactRewriteMethod";
static const char *const CONFIG_ALLOW_CONTACT_REWRITE           = "Account.allowContactRewrite";
