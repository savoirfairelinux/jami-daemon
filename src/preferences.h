...
class AudioPreference : public Serializable {
    public:
        ...
        std::string getUseEchoCanceller() const {
            return useEchoCanceller_;
        }

        void setUseEchoCanceller(const std::string& ec) {
            useEchoCanceller_ = ec;
        }
