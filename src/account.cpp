...
Account::enableUpnp(bool state)
{
    ...
    if (state and !upnp_) {
        ...
        upnp_.reset(new upnp::Controller(upnp::UPnPProtocol::Service::JAMI_ACCOUNT, std::bind(&Account::onPortOpenNotify, this, _1, _2)));
...
void
Account::onPortOpenNotify(uint16_t* port_used, bool success)
{
    JAMI_WARN("Account: Port open notify");
}
