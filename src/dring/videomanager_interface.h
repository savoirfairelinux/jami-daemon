...
bool switchToCamera();
void registerSinkTarget(const std::string& sinkId, const std::function<void(unsigned char*, int, int)>& cb);
void registerSinkTarget(const std::string& sinkId, std::function<void(unsigned char*, int, int)>&& cb);
#ifdef __ANDROID__
