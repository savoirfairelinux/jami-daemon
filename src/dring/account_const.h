...
constexpr static const char CONTACT_REWRITE_METHOD  [] = "Account.contactRewriteMethod";
constexpr static const char ALLOW_CONTACT_REWRITE   [] = "Account.allowContactRewrite";
