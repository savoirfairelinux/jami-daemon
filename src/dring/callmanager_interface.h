...
DRING_PUBLIC bool muteLocalMedia(const std::string& accountId, const std::string& callId, const std::string& mediaType, bool mute);
DRING_PUBLIC bool transfer(const std::string& accountId, const std::string& callId, const std::string& to);
DRING_PUBLIC bool attendedTransfer(const std::string& accountId, const std::string& callId, const std::string& targetID);
DRING_PUBLIC std::map<std::string, std::string> getCallDetails(const std::string& accountId, const std::string& callId);
...
DRING_PUBLIC bool accept(const std::string& accountId, const std::string& callId, const std::vector<DRing::MediaMap>& mediaList);
DRING_PUBLIC bool acceptWithMedia(const std::string& accountId, const std::string& callId,
                                  const std::vector<DRing::MediaMap>& mediaList);
DRING_PUBLIC bool requestMediaChange(const std::string& accountId, const std::string& callId,
                                     const std::vector<DRing::MediaMap>& mediaList);
 ...
 */
DRING_PUBLIC bool answerMediaChangeRequest(const std::string& accountId, const std::string& callId,
                                           const std::vector<DRing::MediaMap>& mediaList);

/* Conference related methods */
DRING_PUBLIC void removeConference(const std::string& accountId, const std::string& confId);
DRING_PUBLIC bool joinParticipant(const std::string& accountId, const std::string& sel_callId, const std::string& drag_callId);
DRING_PUBLIC void createConfFromParticipantList(const std::string& accountId, const std::vector<std::string>& participants);
DRING_PUBLIC void setConferenceLayout(const std::string& accountId, const std::string& confId, uint32_t layout);
DRING_PUBLIC void setActiveParticipant(const std::string& accountId, const std::string& confId, const std::string& callId);
DRING_PUBLIC bool isConferenceParticipant(const std::string& accountId, const std::string& callId);
DRING_PUBLIC bool addParticipant(const std::string& accountId, const std::string& callId, const std::string& confId);
...
DRING_PUBLIC bool joinConference(const std::string& accountId, const std::string& sel_confId, const std::string& drag_confId);
...
DRING_PUBLIC std::vector<std::string> getParticipantList(const std::string& accountId, const std::string& confId);
DRING_PUBLIC std::string getConferenceId(const std::string& accountId, const std::string& callId);
DRING_PUBLIC std::map<std::string, std::string> getConferenceDetails(const std::string& accountId, const std::string& callId);
...
DRING_PUBLIC void muteParticipant(const std::string& accountId,
                                  ...
                                  const std::string& peerId,
                                  const bool& state);
DRING_PUBLIC void hangupParticipant(const std::string& accountId, const std::string& confId, const std::string& participant);
...
DRING_PUBLIC bool switchInput(const std::string& accountId, const std::string& callId, const std::string& resource);
DRING_PUBLIC bool switchSecondaryInput(const std::string& accountId, const std::string& confId, const std::string& resource);
