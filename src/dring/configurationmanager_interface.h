...
DRING_PUBLIC bool searchName(const std::string& account, const std::string& nameserver, const std::string& name);
...
DRING_PUBLIC bool setMessageDisplayed(const std::string& accountID, const std::string& contactId, const std::string& messageId, int status);
...
struct DRING_PUBLIC ConfigurationSignal {
        ...
        struct DRING_PUBLIC SearchEnded {
                constexpr static const char* name = "SearchEnded";
