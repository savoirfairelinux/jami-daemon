...
DRING_PUBLIC struct PresenceSignal {
        DRING_PUBLIC struct NewServerSubscriptionRequest {
                constexpr static const char* name = "NewServerSubscriptionRequest";
                using cb_type = void(const std::string& /*remote*/);
        };
        DRING_PUBLIC struct ServerError {
        ...
        DRING_PUBLIC struct NewBuddyNotification {
        ...
        DRING_PUBLIC struct SubscriptionStateChanged {
