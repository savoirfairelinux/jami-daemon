...
DRING_PUBLIC enum class DataTransferEventCode : uint32_t
{
    invalid=0,
    created,
    unsupported,
...
DRING_PUBLIC enum class DataTransferError : uint32_t
{
    success=0,
    unknown,
    io,
...
DRING_PUBLIC enum class DataTransferFlags
{
    direction=0, ///< 0: outgoing, 1: incoming
};

DRING_PUBLIC struct DataTransferInfo
{
...
/// \note unknown \a id results to a no-op call.
///
DRING_PUBLIC DataTransferError cancelDataTransfer(const DataTransferId& id) noexcept;
...
// Signals
DRING_PUBLIC struct DataTransferSignal
{
    DRING_PUBLIC struct DataTransferEvent
    {
