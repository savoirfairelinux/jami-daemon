...
.libgit2: libgit2
    ...
    && $(CMAKE) -DCMAKE_C_FLAGS="-std=gnu89 -fPIC" -DUSE_HTTPS=OFF -DCURL=OFF -DUSE_HTTP_PARSER=system -DBUILD_CLAR=OFF -DBUILD_SHARED_LIBS=OFF -DUSE_SSH=OFF -DREGEX_BACKEND=regcomp .. \
    && $(MAKE) install
	touch $@
