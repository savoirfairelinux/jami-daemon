...
ifdef HAVE_WIN32
	cd $< && ./autogen.sh && CC=i686-w64-mingw32-gcc CPPFLAGS=-D__MINGW_USE_VC2005_COMPAT ./configure --host=i686-w64-mingw32 && $(MAKE) && DESTDIR=$(PREFIX) $(MAKE) install
else ifdef HAVE_WIN64
	cd $< && ./autogen.sh && CC=x86_64-w64-mingw32-gcc ./configure --host=x86_64-w64-mingw32 -DDESTDIR=$(PREFIX) && $(MAKE) && DESTDIR=$(PREFIX) $(MAKE) install
else
