...
ifeq ($(call need_pkg,"libavutil >= 56.22.100 libavcodec >= 58.35.100 libavformat >= 58.20.100 libavdevice >= 58.5.100 libavfilter >= 7.40.101 libswscale >= 4.7.103 libswresample >= 2.9.100"),)
PKGS_FOUND += ffmpeg
endif
