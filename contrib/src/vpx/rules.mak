...
LOCAL_HOSTVARS=
ifdef HAVE_MACOSX
VPX_CONF += --extra-cxxflags="$(EXTRA_COMMON) $(EXTRA_CXXFLAGS)"
LOCAL_HOSTVARS=$(HOSTVARS) MACOSX_DEPLOYMENT_TARGET=$(MIN_OSX_VERSION)
endif
VPX_CONF += \
LOCAL_HOSTVARS=$(HOSTVARS) MACOSX_DEPLOYMENT_TARGET=$(MIN_OSX_VERSION)
	--extra-cxxflags="$(EXTRA_COMMON) $(EXTRA_CXXFLAGS)"
LOCAL_HOSTVARS=MACOSX_DEPLOYMENT_TARGET=$(MIN_OSX_VERSION)
endif
ifdef HAVE_ANDROID
