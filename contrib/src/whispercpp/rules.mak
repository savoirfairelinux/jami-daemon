...
.whispercpp: whispercpp
	...
	sed -i 's|^Libs:.*|Libs: -L$$\{libdir\} -lwhisper -lggml -lggml-base -lggml-cpu -lggml-blas -lggml-cuda -lopenblas -lcuda -lcudart -lcublas -fopenmp|' $(PREFIX)/lib/pkgconfig/whisper.pc
	touch $@
