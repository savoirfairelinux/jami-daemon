...
pjproject: pjproject-$(PJPROJECT_VERSION).tar.gz .sum-pjproject
	...
	$(APPLY) $(SRC)/pjproject/0016-auto-register-thread.patch
	$(APPLY) $(SRC)/pjproject/0017-fix-ioqueue-lock-acquire.patch
	$(APPLY) $(SRC)/pjproject/0018-resort-check-list-after-adding-prflx.patch # TODO remove with 2.12 (https://github.com/pjsip/pjproject/pull/2806)
	$(APPLY) $(SRC)/pjproject/0019-avoid-immediate-nominating-triggered-check.patch # TODO remove with 2.12 (https://github.com/pjsip/pjproject/issues/2812)
ifdef HAVE_ANDROID
