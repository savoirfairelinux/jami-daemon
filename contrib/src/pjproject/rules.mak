# PJPROJECT
PJPROJECT_VERSION := 3e7b75cb2e482baee58c1991bd2fa4fb06774e0d
PJPROJECT_URL := https://github.com/pjsip/pjproject/archive/$(PJPROJECT_VERSION).tar.gz

PJPROJECT_OPTIONS := --disable-video        \
                     --enable-ext-sound     \
                     --disable-speex-aec    \
                     --disable-g711-codec   \
                     --disable-l16-codec    \
...
pjproject: pjproject-$(PJPROJECT_VERSION).tar.gz .sum-pjproject
	...
	$(APPLY) $(SRC)/pjproject/0003-add_tcp_keep_alive.patch
	...
	$(APPLY) $(SRC)/pjproject/0009-add_config_site.patch
ifdef HAVE_ANDROID
