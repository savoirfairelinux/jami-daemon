...
TORCH_CMAKECONF := \
      ...
      -DUSE_QNNPACK=OFF -DUSE_THREAD-DUSE_PYTORCH_QNNPACK=OFF  -DUSE_XNNPACK=OFF -DUSE_DISTRIBUTED=OFF \
      -DUSE_MKLDNN=OFF -DBUILD_PYTHON=OFF -DBUILD_CAFFE2=ON  -DUSE_NCCL=OFF \
