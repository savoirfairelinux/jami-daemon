...
ifneq ($(call need_pkg,"opencv_contrib >= 4.1.1"),)
DEPS_opencv += opencv_contrib
endif

OPENCV_MODULES := "highgui,imgproc,imgcodecs,face" #ignored for testing
OPENCV_CMAKECONF := \
		-DCMAKE_INSTALL_LIBDIR=lib \
		-DBUILD_SHARED_LIBS=no \
		-DOPENCV_EXTRA_MODULES_PATH="/home/agsantos/Projects/ring-daemon-project/daemon/contrib/native/opencv_contrib/modules" \
