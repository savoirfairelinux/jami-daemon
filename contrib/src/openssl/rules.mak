...
ifdef HAVE_64
	cd $< && D__ANDROID_API__=21 ./Configure --prefix=$(PREFIX) --libdir=lib --cross-compile-prefix=$(CROSS_COMPILE) linux-generic64
else
	cd $< && D__ANDROID_API__=18 ./Configure --prefix=$(PREFIX) --libdir=lib --cross-compile-prefix=$(CROSS_COMPILE) linux-generic32
endif
else
