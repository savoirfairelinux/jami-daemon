...
ifdef HAVE_64
	cd $< && ./Configure --prefix=$(PREFIX) --libdir=lib --cross-compile-prefix=$(CROSS_COMPILE) linux-generic64
else
	cd $< && ./Configure --prefix=$(PREFIX) --libdir=lib --cross-compile-prefix=$(CROSS_COMPILE) linux-generic32
endif
else
