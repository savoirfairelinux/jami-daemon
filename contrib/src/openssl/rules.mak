...
ifdef HAVE_64
	cd $< && D__ANDROID_API__=$(ANDROID_API)./Configure --prefix=$(PREFIX) --libdir=lib --cross-compile-prefix=$(CROSS_COMPILE) linux-generic64
else
	cd $< && D__ANDROID_API__=$(ANDROID_API)./Configure --prefix=$(PREFIX) --libdir=lib --cross-compile-prefix=$(CROSS_COMPILE) linux-generic32
endif
else
