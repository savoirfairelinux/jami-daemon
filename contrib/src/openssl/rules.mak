...
ifdef HAVE_64
	cd $< && ./Configure --prefix=$(PREFIX) --libdir=lib --cross-compile-prefix=$(CROSS_COMPILE) linux-generic64 no-stdio
else
	cd $< && ./Configure --prefix=$(PREFIX) --libdir=lib --cross-compile-prefix=$(CROSS_COMPILE) linux-generic32 no-stdio
endif
else
