...
IAXAccount::newIncomingIAXCall(const std::string& id)
{
...
{
    return newIncomingIAXCall(id);
}

std::shared_ptr<IAXCall>
IAXAccount::newOutgoingIAXCall(const std::string& id, const std::string& toUrl)
{
...
{
    return newOutgoingIAXCall(id, toUrl);
}
