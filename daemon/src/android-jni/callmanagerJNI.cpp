...
CallManagerJNI::CallManagerJNI()
{}

void CallManagerJNI::placeCall(const std::string& accountID,
...
void CallManagerJNI::placeCallFirstAccount(const std::string& callID,
                                        const std::string& to)
{
    using std::vector;
    using std::string;
    ...
    if (to.empty()) {
        WARN("CallManagerJNI: Warning: No number entered, call stopped");
        return;
    }
...
void
CallManagerJNI::refuse(const std::string& callID)
{
    Manager::instance().refuseCall(callID);
}

void
CallManagerJNI::accept(const std::string& callID)
{
    Manager::instance().answerCall(callID);
}

void
CallManagerJNI::hangUp(const std::string& callID)
{
    Manager::instance().hangupCall(callID);
}

void
CallManagerJNI::hangUpConference(const std::string& confID)
{
    Manager::instance().hangupConference(confID);
}

void
CallManagerJNI::hold(const std::string& callID)
{
    Manager::instance().onHoldCall(callID);
}

void
CallManagerJNI::unhold(const std::string& callID)
{
...
double
CallManagerJNI::getVolume(const std::string& device)
{
    AudioLayer *audiolayer = Manager::instance().getAudioDriver();
...
void
CallManagerJNI::joinParticipant(const std::string& sel_callID, const std::string& drag_callID)
{
    Manager::instance().joinParticipant(sel_callID, drag_callID);
}

void
CallManagerJNI::createConfFromParticipantList(const std::vector<std::string>& participants)
{
...
void
CallManagerJNI::addParticipant(const std::string& callID, const std::string& confID)
{
    Manager::instance().addParticipant(callID, confID);
}

void
CallManagerJNI::addMainParticipant(const std::string& confID)
{
...
void
CallManagerJNI::joinConference(const std::string& sel_confID, const std::string& drag_confID)
{
    Manager::instance().joinConference(sel_confID, drag_confID);
}

void
CallManagerJNI::holdConference(const std::string& confID)
{
    Manager::instance().holdConference(confID);
}

void
CallManagerJNI::unholdConference(const std::string& confID)
{
...
CallManagerJNI::getConferenceList()
{
    return Manager::instance().getConferenceList();
}

std::vector<std::string>
CallManagerJNI::getParticipantList(const std::string& confID)
{
    return Manager::instance().getParticipantList(confID);
}

std::string
CallManagerJNI::getConferenceId(const std::string& callID)
{
    return Manager::instance().getConferenceId(callID);
}

bool
CallManagerJNI::startRecordedFilePlayback(const std::string& filepath)
{
    return Manager::instance().startRecordedFilePlayback(filepath);
}

void
CallManagerJNI::stopRecordedFilePlayback(const std::string& filepath)
{
    Manager::instance().stopRecordedFilePlayback(filepath);
}

void
CallManagerJNI::setRecording(const std::string& callID)
{
    Manager::instance().setRecordingCall(callID);
}

void
CallManagerJNI::recordPlaybackSeek(const double& value)
{
    Manager::instance().recordingPlaybackSeek(value);
}

bool
CallManagerJNI::getIsRecording(const std::string& callID)
{
    return Manager::instance().isRecording(callID);
}

std::string CallManagerJNI::getCurrentAudioCodecName(const std::string& callID)
{
    return Manager::instance().getCurrentAudioCodecName(callID);
}

std::map<std::string, std::string>
CallManagerJNI::getCallDetails(const std::string& callID)
{
    return Manager::instance().getCallDetails(callID);
}

std::vector<std::string>
CallManagerJNI::getCallList()
{
    return Manager::instance().getCallList();
}

void
CallManagerJNI::playDTMF(const std::string& key)
{
    Manager::instance().sendDtmf(Manager::instance().getCurrentCallId(), key.data()[0]);
}

void
CallManagerJNI::startTone(const int32_t& start , const int32_t& type)
{
    if (start) {
        if (type == 0)
...
CallManagerJNI::getAudioZrtpSession(const std::string& callID)
{
...
void
CallManagerJNI::setSASVerified(const std::string& callID)
{
#if HAVE_ZRTP
    try {
...
void
CallManagerJNI::resetSASVerified(const std::string& callID)
{
#if HAVE_ZRTP
    try {
        sfl::AudioZrtpSession * zSession;
...
void
CallManagerJNI::setConfirmGoClear(const std::string& callID)
{
#if HAVE_ZRTP
    try {
        sfl::AudioZrtpSession * zSession;
...
void
CallManagerJNI::requestGoClear(const std::string& callID)
{
#if HAVE_ZRTP
    try {
        sfl::AudioZrtpSession * zSession;
...
void
CallManagerJNI::acceptEnrollment(const std::string& callID, const bool& accepted)
{
#if HAVE_ZRTP
    try {
        sfl::AudioZrtpSession * zSession;
