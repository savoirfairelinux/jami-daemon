...
#include "configurationmanagerJNI.h"
...
ConfigurationManagerJNI::ConfigurationManagerJNI() {}

std::map<std::string, std::string> ConfigurationManagerJNI::getIp2IpDetails()
{
...
std::map<std::string, std::string> ConfigurationManagerJNI::getAccountDetails(
...
ConfigurationManagerJNI::getTlsSettingsDefault()
{
...
std::map<std::string, std::string> ConfigurationManagerJNI::getTlsSettings()
{
...
void ConfigurationManagerJNI::setTlsSettings(const std::map<std::string, std::string>& details)
{
    SIPAccount *sipaccount = Manager::instance().getIP2IPAccount();
...
void ConfigurationManagerJNI::setAccountDetails(const std::string& accountID, const std::map<std::string, std::string>& details)
{
    Manager::instance().setAccountDetails(accountID, details);
}

void ConfigurationManagerJNI::sendRegister(const std::string& accountID, const bool& enable)
{
    Manager::instance().sendRegister(accountID, enable);
}

void ConfigurationManagerJNI::registerAllAccounts()
{
    Manager::instance().registerAllAccounts();
}

///This function is used as a base for new accounts for clients that support it
std::map<std::string, std::string> ConfigurationManagerJNI::getAccountTemplate()
{
...
std::string ConfigurationManagerJNI::addAccount(const std::map<std::string, std::string>& details)
{
    return Manager::instance().addAccount(details);
}

void ConfigurationManagerJNI::removeAccount(const std::string& accoundID)
{
    return Manager::instance().removeAccount(accoundID);
}

std::vector<std::string> ConfigurationManagerJNI::getAccountList()
{
...
std::vector<std::string> ConfigurationManagerJNI::getAudioCodecDetails(const int32_t& payload)
{
...
std::vector<int32_t> ConfigurationManagerJNI::getActiveAudioCodecList(const std::string& accountID)
{
...
void ConfigurationManagerJNI::setActiveAudioCodecList(const std::vector<std::string>& list, const std::string& accountID)
{
    Account *acc = Manager::instance().getAccount(accountID);
...
std::vector<std::string> ConfigurationManagerJNI::getAudioPluginList()
{
...
void ConfigurationManagerJNI::setAudioPlugin(const std::string& audioPlugin)
{
    return Manager::instance().setAudioPlugin(audioPlugin);
}

std::vector<std::string> ConfigurationManagerJNI::getAudioOutputDeviceList()
{
    return Manager::instance().getAudioOutputDeviceList();
}

std::vector<std::string> ConfigurationManagerJNI::getAudioInputDeviceList()
{
    return Manager::instance().getAudioInputDeviceList();
}

void ConfigurationManagerJNI::setAudioOutputDevice(const int32_t& index)
{
    return Manager::instance().setAudioDevice(index, AudioLayer::SFL_PCM_PLAYBACK);
}

void ConfigurationManagerJNI::setAudioInputDevice(const int32_t& index)
{
    return Manager::instance().setAudioDevice(index, AudioLayer::SFL_PCM_CAPTURE);
}

void ConfigurationManagerJNI::setAudioRingtoneDevice(const int32_t& index)
{
    return Manager::instance().setAudioDevice(index, AudioLayer::SFL_PCM_RINGTONE);
}

std::vector<std::string> ConfigurationManagerJNI::getCurrentAudioDevicesIndex()
{
    return Manager::instance().getCurrentAudioDevicesIndex();
}

int32_t ConfigurationManagerJNI::getAudioDeviceIndex(const std::string& name)
{
    return Manager::instance().getAudioDeviceIndex(name);
}

std::string ConfigurationManagerJNI::getCurrentAudioOutputPlugin()
{
...
std::string ConfigurationManagerJNI::getNoiseSuppressState()
{
    return Manager::instance().getNoiseSuppressState();
}

void ConfigurationManagerJNI::setNoiseSuppressState(const std::string& state)
{
    Manager::instance().setNoiseSuppressState(state);
}

std::string ConfigurationManagerJNI::getEchoCancelState()
{
    return Manager::instance().getEchoCancelState() ? "enabled" : "disabled";
}

std::map<std::string, std::string> ConfigurationManagerJNI::getRingtoneList()
{
...
std::string ConfigurationManagerJNI::getRecordPath()
{
    return Manager::instance().audioPreference.getRecordPath();
}

void ConfigurationManagerJNI::setRecordPath(const std::string& recPath)
{
    Manager::instance().audioPreference.setRecordPath(recPath);
}

bool ConfigurationManagerJNI::getIsAlwaysRecording()
{
    return Manager::instance().getIsAlwaysRecording();
}

void ConfigurationManagerJNI::setIsAlwaysRecording(const bool& rec)
{
...
void ConfigurationManagerJNI::clearHistory()
{
    return Manager::instance().clearHistory();
}

void ConfigurationManagerJNI::setHistoryLimit(const int32_t& days)
{
    Manager::instance().setHistoryLimit(days);
}

void ConfigurationManagerJNI::setAudioManager(const std::string& api)
{
    Manager::instance().setAudioManager(api);
}

std::string ConfigurationManagerJNI::getAudioManager()
{
...
int32_t ConfigurationManagerJNI::getMailNotify()
{
    return Manager::instance().getMailNotify();
}

std::map<std::string, int32_t> ConfigurationManagerJNI::getAddressbookSettings()
{
    return Manager::instance().getAddressbookSettings();
}

void ConfigurationManagerJNI::setAddressbookSettings(const std::map<std::string, int32_t>& settings)
{
    Manager::instance().setAddressbookSettings(settings);
}

std::vector<std::string> ConfigurationManagerJNI::getAddressbookList()
{
    return Manager::instance().getAddressbookList();
}

void ConfigurationManagerJNI::setAddressbookList(const std::vector<std::string>& list)
{
...
void ConfigurationManagerJNI::setHookSettings(const std::map<std::string,
        std::string>& settings)
{
    Manager::instance().hookPreference = HookPreference(settings);
}

void ConfigurationManagerJNI::setAccountsOrder(const std::string& order)
{
    Manager::instance().setAccountsOrder(order);
}

std::vector<std::map<std::string, std::string> > ConfigurationManagerJNI::getHistory()
{
    return Manager::instance().getHistory();
}

std::string
ConfigurationManagerJNI::getAddrFromInterfaceName(const std::string& interface)
{
    return SipTransport::getInterfaceAddrFromName(interface);
}

std::vector<std::string> ConfigurationManagerJNI::getAllIpInterface()
{
    return SipTransport::getAllIpInterface();
}

std::vector<std::string> ConfigurationManagerJNI::getAllIpInterfaceByName()
{
    return SipTransport::getAllIpInterfaceByName();
}

std::map<std::string, std::string> ConfigurationManagerJNI::getShortcuts()
{
    return Manager::instance().shortcutPreferences.getShortcuts();
}

void ConfigurationManagerJNI::setShortcuts(
...
std::vector<std::map<std::string, std::string> > ConfigurationManagerJNI::getCredentials(
    const std::string& accountID)
{
...
void ConfigurationManagerJNI::setCredentials(const std::string& accountID,
