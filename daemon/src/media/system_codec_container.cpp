...
{
    const bool isDynamicPayload = true;
    const bool isStaticPayload = ! isDynamicPayload;

    availableCodecList_ = {
        /* Define supported video codec*/
        std::make_shared<SystemVideoCodecInfo>(AV_CODEC_ID_H264,
                                               "H264", "libx264",
                                               CODEC_ENCODER_DECODER, isDynamicPayload),
        ...
        std::make_shared<SystemAudioCodecInfo>(AV_CODEC_ID_PCM_ALAW,
                                               "PCMA", "pcm_alaw",
                                               CODEC_ENCODER_DECODER, isStaticPayload,
                                               64, 8000, 1, 8),
