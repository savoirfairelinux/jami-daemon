...
MediaAudioCodec::MediaAudioCodec(unsigned avcodecId, const std::string name, std::string libName, CodecType type, uint16_t bitrate, uint16_t sampleRate, uint16_t nbChannels, uint16_t payloadType, bool isActive)
