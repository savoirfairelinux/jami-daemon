...
namespace ring {
MediaCodec::MediaCodec(AVCodecID avcodecId, const std::string name, std::string libName, MediaType mediaType, CodecType codecType, uint16_t bitrate, uint16_t payloadType, bool isActive)
{
