 ...
 */
SystemAudioCodecInfo::SystemAudioCodecInfo(unsigned avcodecId,
                                           const std::string name,
                                           std::string libName,
                                           CodecType type, unsigned bitrate,
                                           unsigned sampleRate,
                                           unsigned nbChannels,
...
{
    return { name_,                              // name of the codec
            std::to_string(sampleRate_),        // sample rate
            std::to_string(bitrate_),           // bit rate
            std::to_string(nbChannels_)         // channel number
            };
}
