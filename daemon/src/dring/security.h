...
namespace DRing {
   ...
   namespace Certificate {
      ...
      namespace ChecksNames {
         ...
         constexpr static const char* PRIVATEKEY_DIRECTORY_PERMISSIONS = "PRIVATEKEY_DIRECTORY_PERMISSIONS";
         constexpr static const char* PUBLICKEY_DIRECTORY_PERMISSIONS  = "PUBLICKEY_DIRECTORY_PERMISSIONS" ;
