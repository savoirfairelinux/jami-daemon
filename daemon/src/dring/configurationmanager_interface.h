...
/* configuration signal handler types */
using on_volume_change = std::function<void (const std::string& /*device*/, double /*value*/)>;
using on_accounts_change = std::function<void ()>;

using ConfigHandlers = std::tuple<on_volume_change, on_accounts_change>;
