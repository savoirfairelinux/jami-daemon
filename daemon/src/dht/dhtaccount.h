...
namespace Conf {
    ...
    const char *const DHT_PUBKEY_PATH_KEY = "dhtPubkeyPath";
}
...
class DHTAccount : public SIPAccountBase {
    public:
        ...
        void createOutgoingCall (std::shared_ptr<SIPCall> call, const std::string& to, const std::string& toUrl, int family);
