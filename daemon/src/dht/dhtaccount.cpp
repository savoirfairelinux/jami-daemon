    ...
    : SIPAccountBase(accountID)
{
    ...
    if (identityPath_.empty()) {
        ...
        identityPath_ = idPath+DIR_SEPARATOR_STR+"id_rsa";
...
void DHTAccount::initTlsConfiguration()
{
    ...
    pj_cstr(&tlsSetting_.cert_file, (identityPath_+".pub").c_str());
    pj_cstr(&tlsSetting_.privkey_file, identityPath_.c_str());
