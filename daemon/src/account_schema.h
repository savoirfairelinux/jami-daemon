...
static const char *const CONFIG_TRANSPORT_STATE_CODE            = "TLS.transportStatusCode";
static const char *const CONFIG_TRANSPORT_STATE_DESC            = "TLS.transportStatusDescription";
