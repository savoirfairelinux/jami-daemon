...
class ManagerImpl {
    ...
    private:
        ...
        /**
         * Instance of the RingBufferMananger for the whole application
         *
    ...
    public:
        ...
        /**
         * Return a pointer to the instance of the RingBufferManager
         */
        RingBufferManager& getRingBufferManager() { return *ringbuffermanager_; }
