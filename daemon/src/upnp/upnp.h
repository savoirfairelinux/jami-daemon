...
class Mapping {
public:
    constexpr static const char * const UPNP_DEFAULT_MAPPING_DESCRIPTION = "RING";
    constexpr static const uint16_t UPNP_PORT_MIN = 1024;
    constexpr static const uint16_t UPNP_PORT_MAX = 65535;

    IGD igd; /* the IGD associated with this mapping */
...
protected:
     ...
     */
    static std::map<uint16_t, Mapping> udpMappings_;
    static std::map<uint16_t, Mapping> tcpMappings_;
