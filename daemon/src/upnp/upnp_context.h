...
public:
    ...
    const int SEARCH_TIMEOUT_SEC = 30;
     ...
     *
     * note: this function will call hasValidIGD and so will wait upto SEARCH_TIMEOUT_SEC
     */
...
private:
    ...
    /**
     * map of valid IGDs - IGDs which have the correct services and are connected to the Internet
     *
    ...
    /**
     * chooses the IGD to use (currently slects the first one in the map)
