...
private:
    ...
    void removeMappingsByLocalIPAndDescription(std::shared_ptr<IGD>, const std::string&);
    bool deletePortMapping(std::shared_ptr<IGD>, const std::string&, const std::string&);
