...
bool
UPnPContext::isIGDConnected(IGD *igd)
{
...
IpAddr
UPnPContext::getExternalIP(IGD *igd)
{
    std::unique_ptr<IXML_Document, decltype(ixmlDocument_free)&> action(nullptr, ixmlDocument_free);
...
void
UPnPContext::removeMappingsByLocalIPAndDescription(IGD *igd, const std::string& description)
{
...
bool
UPnPContext::deletePortMapping(IGD *igd, const std::string& port_external, const std::string& protocol)
{
...
bool
UPnPContext::addPortMapping(IGD *igd, const Mapping& mapping, int *error_code)
{
    *error_code = 0;
