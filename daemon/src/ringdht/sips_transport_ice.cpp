        ...
        })
{
    ...
    //if (is_server_)
        gnutls_priority_init(&priority_cache, "SUITEB192:-VERS-TLS-ALL:+VERS-DTLS1.0:%SERVER_PRECEDENCE", nullptr);
    //else
    //    gnutls_priority_init(&priority_cache, "SUITEB192", nullptr);
