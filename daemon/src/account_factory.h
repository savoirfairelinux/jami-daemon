...
class AccountFactory {
    public:
        constexpr static const char* const SIP_ACCOUNT_TYPE = "SIP";
        constexpr static const char* const IAX_ACCOUNT_TYPE = "IAX";
        constexpr static const char* const DEFAULT_ACCOUNT_TYPE = SIP_ACCOUNT_TYPE;
