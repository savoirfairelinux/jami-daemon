...
{
    auto &rbm = Manager::instance().getRingBufferManager();
    ...
    rbm.bindCallID(participant_id, RingBufferManager::DEFAULT_ID);
    rbm.flush(RingBufferManager::DEFAULT_ID);
}
...
bool Conference::toggleRecording()
{
    ...
    if (startRecording) {
        ...
        rbm.bindHalfDuplexOut(process_id, RingBufferManager::DEFAULT_ID);
        ...
        rbm.unBindHalfDuplexOut(process_id, RingBufferManager::DEFAULT_ID);
    }
