...
class VideoDeviceImpl {
    public:
        ...
        void trySettings(VideoSettings settings);
...
void
VideoDeviceImpl::trySettings(VideoSettings settings)
{
...
void
VideoDevice::trySettings(VideoSettings settings)
{
    deviceImpl_->trySettings(settings);
}
