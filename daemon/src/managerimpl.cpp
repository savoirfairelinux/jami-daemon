...
std::set<std::shared_ptr<VoIPLink> >
ManagerImpl::getAllVoIPLink()
{
    static std::set<std::shared_ptr<VoIPLink> > voiplinks = {};
    return voiplinks;
}
