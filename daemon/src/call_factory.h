...
class CallFactory {
    public:
        ...
        /**
         * Return if given call existing, optionaly in given type
         */
        ...
        /**
         * Erase all calls, optionaly in given type
         */
        template <class T = Call>
        void clear() {
            std::lock_guard<std::recursive_mutex> lk(callMapsMutex_);
        ...
        /**
         * Return if calls exist, optionaly in given type
         */
        template <class T = Call>
        bool empty() const {
            std::lock_guard<std::recursive_mutex> lk(callMapsMutex_);
        ...
        /**
         * Return call pointer associated to given ID, optionaly in given type
         */
        template <class T = Call>
        ...
        /**
         * Return all calls, optionaly in given type
         */
        template <class T = Call>
        ...
        /**
         * Return all call's IDs, optionaly in given type
         */
        template <class T = Call>
        ...
        /**
         * Return number of calls, optionaly in given type
         */
        template <class T = Call>
