...
class CallFactory {
    public:
        ...
        /**
         * Return if given call exists. Type can optionaly be specified.
         */
        ...
        /**
         * Return if calls exist. Type can optionaly be specified.
         */
        template <class T = Call>
        bool empty() const {
            std::lock_guard<std::recursive_mutex> lk(callMapsMutex_);
        ...
        /**
         * Erase all calls. Type can optionaly be specified.
         */
        template <class T = Call>
        void clear() {
            std::lock_guard<std::recursive_mutex> lk(callMapsMutex_);
        ...
        /**
         * Return call pointer associated to given ID. Type can optionaly be specified.
         */
        template <class T = Call>
        ...
        /**
         * Return all calls. Type can optionaly be specified.
         */
        template <class T = Call>
        ...
        /**
         * Return all call's IDs. Type can optionaly be specified.
         */
        template <class T = Call>
        ...
        /**
         * Return number of calls. Type can optionaly be specified.
         */
        template <class T = Call>
    ...
    private:
        ...
        std::atomic_bool enableNewCall_ = {true};
        std::map<std::string, CallMap<Call> > callMaps_ = {};

        void registerCall_(std::shared_ptr<Call> call);
        ...
        const CallMap<Call>* getMap_() const {
            ...
            if (itermap != callMaps_.cend())
                ...
                WARN("unknown link %s", T::LINK_TYPE);
