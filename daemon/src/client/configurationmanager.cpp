...
std::vector<std::string> ConfigurationManager::getSupportedCiphers(const std::string& accountID)
{
#if HAVE_TLS
    ...
    if (sipaccount) {
        ...
        ERROR("Could not get supported ciphers account details on a non-existing accountID");
