...
void Preferences::unserialize2()
{
    using namespace yaml_utils;
    YAML::Node doc = YAML::LoadFile("/home/tristan/.config/sflphone/fake");
    const auto &pref = doc["preferences"];
...
void VoipPreference::unserialize2()
{
    using namespace yaml_utils;
    YAML::Node doc = YAML::LoadFile("/home/tristan/.config/sflphone/fake");
    const auto &pref = doc["voipPreferences"];
...
void HookPreference::unserialize2()
{
    using namespace yaml_utils;
    YAML::Node doc = YAML::LoadFile("/home/tristan/.config/sflphone/fake");

    const auto &h = doc["hooks"];
...
void AudioPreference::unserialize2()
{
    using namespace yaml_utils;
    YAML::Node doc = YAML::LoadFile("/home/tristan/.config/sflphone/fake");
...
void ShortcutPreferences::unserialize2()
{
    using namespace yaml_utils;
    YAML::Node doc = YAML::LoadFile("/home/tristan/.config/sflphone/fake");
    const auto &shortcuts = doc["shortcuts"];
