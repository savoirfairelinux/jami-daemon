...
AudioBuffer::AudioBuffer(size_t sample_num, unsigned channel_num, int sample_rate /* = 8000 */)
...
AudioBuffer::AudioBuffer(const SFLAudioSample* in, size_t sample_num, unsigned channel_num, int sample_rate /* = 8000 */)
    :  sampleRate_(sample_rate),
