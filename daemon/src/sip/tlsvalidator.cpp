...
const sfl::Matrix1D<TlsValidator::CertificateCheck, TlsValidator::CheckValuesType> TlsValidator::enforcedCheckType = {{
    /*      CertificateCheck                       Callback     */
    /*EMBED_PRIVATE_KEY              */ CheckValuesType::BOOLEAN ,
    /*CERTIFICATE_EXPIRED            */ CheckValuesType::BOOLEAN ,
    /*WEAK_SIGNING                   */ CheckValuesType::BOOLEAN ,
    /*CERTIFICATE_SELF_SIGNED        */ CheckValuesType::BOOLEAN ,
    /*PRIVATE_KEY_MISSING            */ CheckValuesType::BOOLEAN , // TODO remove
    /*CERTIFICATE_KEY_MISMATCH       */ CheckValuesType::BOOLEAN ,
    ...
    /*MISSING_CERTIFICATE            */ CheckValuesType::BOOLEAN ,
    /*INVALID_CERTIFICATE            */ CheckValuesType::BOOLEAN ,
    /*INVALID_AUTHORITY              */ CheckValuesType::BOOLEAN ,
    /*UNKOWN_AUTHORITY               */ CheckValuesType::BOOLEAN ,
    /*REVOKED                        */ CheckValuesType::BOOLEAN ,
    /*CERTIFICATE_EXPIRATION_DATE    */ CheckValuesType::ISO_DATE,
    /*CERTIFICATE_ACTIVATION_DATE    */ CheckValuesType::ISO_DATE,
    /*CERTIFICATE_AUTHORITY_MISMATCH */ CheckValuesType::BOOLEAN ,
...
std::map<std::string,std::string> TlsValidator::serializeAll()
{
    ...
    if (not certificateFound_) {
        ...
        ret[CertificateCheckNames[CertificateCheck::MISSING_CERTIFICATE]]
            = getStringValue(CertificateCheck::MISSING_CERTIFICATE,exist());
    }
    else {
//         ret[CertificateCheckNames[CertificateCheck::EMBED_PRIVATE_KEY]] = getStringValue(CertificateCheck::EMBED_PRIVATE_KEY,embedPrivateKey());
        for ( const CertificateCheck check : sfl::Matrix0D<CertificateCheck>() )
...
unsigned int TlsValidator::compareToCa()
{
    ...
    if (certificateFound_ or (not caCert_) or caCert_->validCertificate().first == CheckValues::FAILED)
