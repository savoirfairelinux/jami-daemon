...
void SIPAccount::serialize(Conf::YamlEmitter &emitter)
{
    ...
    for (const auto &cred : credentials_) {
        try {
            MappingNode map;
            map.setKeyValue(CONFIG_ACCOUNT_USERNAME, ScalarNode(cred.at(CONFIG_ACCOUNT_USERNAME)));
            map.setKeyValue(CONFIG_ACCOUNT_PASSWORD, ScalarNode(cred.at(CONFIG_ACCOUNT_PASSWORD)));
            map.setKeyValue(CONFIG_ACCOUNT_REALM, ScalarNode(cred.at(CONFIG_ACCOUNT_REALM)));
