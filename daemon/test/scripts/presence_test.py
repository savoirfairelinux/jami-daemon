...
bus = dbus.SessionBus()
presenceManagerBus          = bus.get_object('org.ring.Ring', '/org/ring/Ring/PresenceManager')
presenceManager             = dbus.Interface(presenceManagerBus, dbus_interface='org.ring.Ring.PresenceManager')
configurationManagerBus = bus.get_object('org.ring.Ring', '/org/ring/Ring/ConfigurationManager')
configurationManager    = dbus.Interface(configurationManagerBus, dbus_interface='org.ring.Ring.ConfigurationManager')
...
if __name__ == '__main__':
    ...
    try:
        # dbus signal monitor
        presenceManagerBus.connect_to_signal("newBuddyNotification", newPresSubCientNotificationHandler, dbus_interface='org.ring.Ring.PresenceManager')
        presenceManagerBus.connect_to_signal("newServerSubscriptionRequest", newPresSubServerRequestHandler, dbus_interface='org.ring.Ring.PresenceManager')
        presenceManagerBus.connect_to_signal("subcriptionStateChanged", subcriptionStateChangedHandler, dbus_interface='org.ring.Ring.PresenceManager')
        presenceManagerBus.connect_to_signal("serverError", serverErrorHandler, dbus_interface='org.ring.Ring.PresenceManager')
