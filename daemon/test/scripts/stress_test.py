...
def reInit():
	try:
		...
		callManagerBus          = bus.get_object('org.ring.Ring', '/org/ring/Ring/CallManager')
		callManager             = dbus.Interface(callManagerBus, dbus_interface='org.ring.Ring.CallManager')
		...
		instanceManagerBus      = bus.get_object('org.ring.Ring', '/org/ring/Ring/Instance')
		instanceManager         = dbus.Interface(instanceManagerBus     , dbus_interface='org.ring.Ring.Instance')
