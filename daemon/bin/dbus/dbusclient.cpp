...
int DBusClient::initLibrary(int sflphFlags)
{
    ...
    const std::map<std::string, SharedCallback> videoHandlers = {
        ...
        exportable_callback<VideoSignal::StartDecoding>(bind(&DBusVideoManager::startedDecoding, videoM, _1, _2, _3, _4, _5)),
        exportable_callback<VideoSignal::StopDecoding>(bind(&DBusVideoManager::stoppedDecoding, videoM, _1, _2, _3)),
    };
