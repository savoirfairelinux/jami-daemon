...
static int osxTests()
{
    ring::ring_call_ev_handlers callEvHandlers;
    ring::ring_config_ev_handlers configEvHandlers;
    ring::ring_pres_ev_handlers presEvHandlers;
...
#ifdef RING_VIDEO
    ring::ring_video_ev_handlers videoEvHandlers;
    evHandlers.emplace(EventHandlerKey::CALL, static_cast<void*>(&callEvHandlers));
#endif
