...
void register_sflphone_stock_icons(GtkIconTheme *theme)
{
    ...
    add_icon(theme, GTK_STOCK_PREFS_SHORTCUT, gnome_stock_prefs_shortcut, GTK_ICON_SIZE_LARGE_TOOLBAR);
    add_icon(theme, GTK_STOCK_PREFS_HOOK, gnome_stock_prefs_hook, GTK_ICON_SIZE_LARGE_TOOLBAR);
    add_icon(theme, GTK_STOCK_PREFS_ADDRESSBOOK, gnome_stock_prefs_addressbook, GTK_ICON_SIZE_LARGE_TOOLBAR);
}
