...
static void       video_widget_set_minimal_size         (GtkWidget *, guint, guint);
...
video_widget_redraw_screen(GtkWidget *self)
{
    ...
    gint width = 0, height = 0, pos_x = 0, pos_y = 0, screen_width = 0, screen_height = 0;
                              ...
                              guint height)
{
    ...
    gtk_window_set_geometry_hints(GTK_WINDOW(self), NULL, &geom, GDK_HINT_MIN_SIZE);
