...
{
    const char *dbus_message_bus_name = "org.ring.Ring";
    const char *dbus_object_instance = "/org/ring/Ring/Instance";
    const char *dbus_interface = "org.ring.Ring.Instance";
    const char *callmanager_object_instance = "/org/ring/Ring/CallManager";
    const char *callmanager_interface = "org.ring.Ring.CallManager";
    const char *configurationmanager_object_instance = "/org/ring/Ring/ConfigurationManager";
    const char *configurationmanager_interface = "org.ring.Ring.ConfigurationManager";
    const char *presencemanager_object_instance = "/org/ring/Ring/PresenceManager";
    const char *presencemanager_interface = "org.ring.Ring.PresenceManager";
...
#ifdef SFL_VIDEO
    const gchar *videomanager_object_instance = "/org/ring/Ring/VideoManager";
    const gchar *videomanager_interface = "org.ring.Ring.VideoManager";
...
void dbus_hold(const callable_obj_t *c)
{
    GError *error = NULL;
    gboolean result;
    org_ring_Ring_CallManager_hold(call_proxy, c->_callID, &result, &error);
    check_error(error);
}
...
dbus_unhold(const callable_obj_t *c)
{
    GError *error = NULL;
    gboolean result;
    org_ring_Ring_CallManager_unhold(call_proxy, c->_callID, &result, &error);
    check_error(error);
}
...
dbus_hold_conference(const conference_obj_t *c)
{
    GError *error = NULL;
    gboolean result;
    org_ring_Ring_CallManager_hold_conference(call_proxy, c->_confID,
            &result, &error);
    check_error(error);
}
...
dbus_unhold_conference(const conference_obj_t *c)
{
    GError *error = NULL;
    gboolean result;
    org_ring_Ring_CallManager_unhold_conference(call_proxy, c->_confID,
            &result, &error);
    check_error(error);
}
...
dbus_start_recorded_file_playback(const gchar *filepath)
{
    ...
    org_ring_Ring_CallManager_start_recorded_file_playback(call_proxy, filepath, &result, &error);
    check_error(error);
    return result;
}
...
{
    GError *error = NULL;
    org_ring_Ring_CallManager_stop_recorded_file_playback(call_proxy, filepath, &error);
    check_error(error);
}
...
{
    org_ring_Ring_CallManager_hang_up_async(call_proxy, c->_callID, hang_up_reply_cb, NULL);
}

void
dbus_hang_up_conference(const conference_obj_t *c)
{
    org_ring_Ring_CallManager_hang_up_conference_async(call_proxy, c->_confID, hang_up_reply_cb, NULL);
}
...
dbus_transfer(const callable_obj_t *c)
{
    GError *error = NULL;
    gboolean result;
    org_ring_Ring_CallManager_transfer(call_proxy, c->_callID,
...
dbus_attended_transfer(const callable_obj_t *transfer, const callable_obj_t *target)
{
    GError *error = NULL;
    gboolean result;
    org_ring_Ring_CallManager_attended_transfer(call_proxy, transfer->_callID,
...
dbus_accept(const callable_obj_t *c)
{
    ...
    GError *error = NULL;
    gboolean result;
    org_ring_Ring_CallManager_accept(call_proxy, c->_callID, &result, &error);
    check_error(error);
}
...
dbus_refuse(const callable_obj_t *c)
{
    ...
    GError *error = NULL;
    gboolean result;
    org_ring_Ring_CallManager_refuse(call_proxy, c->_callID, &result, &error);
    check_error(error);
}
...
dbus_place_call(const callable_obj_t *c)
{
    GError *error = NULL;
    gboolean result;
    org_ring_Ring_CallManager_place_call(call_proxy, c->_accountID,
...
dbus_account_list()
{
    ...
    org_ring_Ring_ConfigurationManager_get_account_list(config_proxy, &array, &error);
    check_error(error);
...
dbus_get_account_template()
{
    ...
    org_ring_Ring_ConfigurationManager_get_account_template(config_proxy, &details, &error);
    check_error(error);
...
dbus_get_account_details(const gchar *accountID)
{
    ...
    org_ring_Ring_ConfigurationManager_get_account_details(config_proxy, accountID, &details, &error);
    check_error(error);
...
dbus_set_credentials(account_t *a)
{
    g_assert(a);
    GError *error = NULL;
    org_ring_Ring_ConfigurationManager_set_credentials(config_proxy, a->accountID,
...
dbus_get_credentials(account_t *a)
{
    g_assert(a);
    GError *error = NULL;
    org_ring_Ring_ConfigurationManager_get_credentials(config_proxy,
...
dbus_get_ip2ip_details(void)
{
    ...
    org_ring_Ring_ConfigurationManager_get_ip2_ip_details(config_proxy, &details, &error);
    check_error(error);
...
{
    GError *error = NULL;
    org_ring_Ring_ConfigurationManager_send_register(config_proxy, accountID, enable, &error);
    check_error(error);
}
...
{
    GError *error = NULL;
    org_ring_Ring_ConfigurationManager_remove_account(config_proxy, accountID, &error);
...
dbus_set_account_details(const account_t *a)
{
    g_assert(a);
    GError *error = NULL;
    org_ring_Ring_ConfigurationManager_set_account_details(config_proxy, a->accountID, a->properties,
                               &error);
    check_error(error);
}
...
dbus_add_account(account_t *a)
{
    ...
    GError *error = NULL;
    a->accountID = NULL;
    org_ring_Ring_ConfigurationManager_add_account(config_proxy, a->properties, &a->accountID,
                       &error);
    check_error(error);
}
...
{
    GError *error = NULL;
    org_ring_Ring_ConfigurationManager_set_volume(config_proxy, device, value, &error);
    check_error(error);
}
...
{
    GError *error = NULL;
    org_ring_Ring_ConfigurationManager_mute_capture(config_proxy, muted, &error);
    check_error(error);
}
...
{
    GError *error = NULL;
    org_ring_Ring_ConfigurationManager_mute_dtmf(config_proxy, muted, &error);
    check_error(error);
}
...
{
    GError *error = NULL;
    org_ring_Ring_ConfigurationManager_mute_playback(config_proxy, muted, &error);
    check_error(error);
}
...
dbus_is_dtmf_muted()
{
    GError *error = NULL;
    gboolean muted;
    org_ring_Ring_ConfigurationManager_is_dtmf_muted(config_proxy, &muted, &error);
    check_error(error);
    return muted;
}
...
dbus_is_capture_muted()
{
    GError *error = NULL;
    gboolean muted;
    org_ring_Ring_ConfigurationManager_is_capture_muted(config_proxy, &muted, &error);
    check_error(error);
    return muted;
}
...
dbus_is_playback_muted()
{
    GError *error = NULL;
    gboolean muted;
    org_ring_Ring_ConfigurationManager_is_playback_muted(config_proxy, &muted, &error);
    check_error(error);
    return muted;
}
...
dbus_get_volume(const gchar *device)
{
    gdouble value;
    GError *error = NULL;
    org_ring_Ring_ConfigurationManager_get_volume(config_proxy, device, &value, &error);
    check_error(error);
    return value;
}
...
{
    GError *error = NULL;
    org_ring_Ring_CallManager_play_dt_mf(call_proxy, key, &error);
    check_error(error);
}
...
{
    GError *error = NULL;
    org_ring_Ring_CallManager_start_tone(call_proxy, start, type, &error);
    check_error(error);
}
...
{
    return org_ring_Ring_Instance_register(instance_proxy, pid, name,
                                                   error);
}
...
{
    GError *error = NULL;
    org_ring_Ring_Instance_unregister_async(instance_proxy, pid, NULL, NULL);
    check_error(error);
}
...
dbus_audio_codec_list()
{
    GError *error = NULL;
    GArray *array = NULL;
    org_ring_Ring_ConfigurationManager_get_audio_codec_list(config_proxy, &array, &error);
    check_error(error);
    return array;
}
...
dbus_get_video_codecs(const gchar *accountID)
{
    ...
    org_ring_Ring_VideoManager_get_codecs(video_proxy, accountID, &array, &error);
    check_error(error);
    return array;
}
...
{
    GError *error = NULL;
    org_ring_Ring_VideoManager_set_codecs(video_proxy, accountID, list, &error);
    check_error(error);
}
...
dbus_switch_video_input(const gchar *resource)
{
    GError *error = NULL;
    gboolean switched;
    org_ring_Ring_VideoManager_switch_input(video_proxy, resource, &switched, &error);
    check_error(error);
    return switched;
}
#endif
...
dbus_audio_codec_details(int payload)
{
    GError *error = NULL;
    gchar **array;
    org_ring_Ring_ConfigurationManager_get_audio_codec_details(config_proxy, payload, &array, &error);
    check_error(error);
    return array;
}
...
dbus_get_active_audio_codec_list(const gchar *accountID)
{
    GArray *array = NULL;
    GError *error = NULL;
    org_ring_Ring_ConfigurationManager_get_active_audio_codec_list(config_proxy, accountID, &array,
                                       &error);
    check_error(error);
...
{
    GError *error = NULL;
    org_ring_Ring_ConfigurationManager_set_active_audio_codec_list(config_proxy, list, accountID, &error);
    check_error(error);
}
...
dbus_get_audio_plugin_list()
{
    ...
    org_ring_Ring_ConfigurationManager_get_audio_plugin_list(config_proxy, &array, &error);
    check_error(error);
...
{
    GError *error = NULL;
    org_ring_Ring_ConfigurationManager_set_audio_plugin(config_proxy, audioPlugin, &error);
    check_error(error);
}
...
dbus_get_audio_output_device_list()
{
    gchar **array = NULL;
    GError *error = NULL;
    org_ring_Ring_ConfigurationManager_get_audio_output_device_list(config_proxy, &array, &error);
    check_error(error);
    return array;
}
...
{
    GError *error = NULL;
    org_ring_Ring_ConfigurationManager_set_audio_output_device(config_proxy, device, &error);
    check_error(error);
}
...
{
    GError *error = NULL;
    org_ring_Ring_ConfigurationManager_set_audio_input_device(config_proxy, device, &error);
    check_error(error);
}
...
{
    GError *error = NULL;
    org_ring_Ring_ConfigurationManager_set_audio_ringtone_device(config_proxy, device, &error);
    check_error(error);
}
...
dbus_get_audio_input_device_list()
{
    gchar **array = NULL;
    GError *error = NULL;
    org_ring_Ring_ConfigurationManager_get_audio_input_device_list(config_proxy, &array, &error);
    check_error(error);
...
dbus_get_current_audio_devices_index()
{
    gchar **array = NULL;
    GError *error = NULL;
    org_ring_Ring_ConfigurationManager_get_current_audio_devices_index(config_proxy, &array, &error);
    check_error(error);
...
dbus_get_audio_output_device_index(const gchar *name)
{
    int device_index = 0;
    GError *error = NULL;
    org_ring_Ring_ConfigurationManager_get_audio_output_device_index(config_proxy, name, &device_index, &error);
    check_error(error);
...
dbus_get_audio_input_device_index(const gchar *name)
{
    int device_index = 0;
    GError *error = NULL;
    org_ring_Ring_ConfigurationManager_get_audio_input_device_index(config_proxy, name, &device_index, &error);
    check_error(error);
...
dbus_get_current_audio_output_plugin()
{
    gchar *plugin;
    GError *error = NULL;
    org_ring_Ring_ConfigurationManager_get_current_audio_output_plugin(config_proxy, &plugin, &error);
...
dbus_get_noise_suppress_state()
{
    gboolean state;
    GError *error = NULL;
    org_ring_Ring_ConfigurationManager_get_noise_suppress_state(config_proxy, &state, &error);
...
{
    GError *error = NULL;
    org_ring_Ring_ConfigurationManager_set_noise_suppress_state(config_proxy, state, &error);
    check_error(error);
}
...
dbus_get_agc_state()
{
    gboolean state;
    GError *error = NULL;
    org_ring_Ring_ConfigurationManager_is_agc_enabled(config_proxy, &state, &error);
...
{
    GError *error = NULL;
    org_ring_Ring_ConfigurationManager_set_agc_state(config_proxy, state, &error);
    check_error(error);
}
...
dbus_is_iax2_enabled()
{
    int res = 0;
    GError *error = NULL;
    org_ring_Ring_ConfigurationManager_is_iax2_enabled(config_proxy, &res, &error);
    check_error(error);
...
{
    org_ring_Ring_CallManager_join_participant_async(call_proxy, sel_callID,
...
{
    org_ring_Ring_CallManager_add_participant_async(call_proxy, callID,
...
{
    org_ring_Ring_CallManager_add_main_participant_async(call_proxy,
...
dbus_detach_participant(const gchar *callID)
{
    GError *error = NULL;
    gboolean result;
    org_ring_Ring_CallManager_detach_participant(call_proxy, callID,
            &result, &error);
    check_error(error);
}
...
dbus_join_conference(const gchar *sel_confID, const gchar *drag_confID)
{
    GError *error = NULL;
    gboolean result;
    org_ring_Ring_CallManager_join_conference(call_proxy, sel_confID,
...
dbus_toggle_recording(const gchar *id)
{
    ...
    org_ring_Ring_CallManager_toggle_recording(call_proxy, id, &isRecording, &error);
    check_error(error);
    return isRecording;
}
...
dbus_get_is_recording(const callable_obj_t *c)
{
    GError *error = NULL;
    gboolean isRecording;
    org_ring_Ring_CallManager_get_is_recording(call_proxy, c->_callID, &isRecording, &error);
    check_error(error);
...
{
    GError *error = NULL;
    org_ring_Ring_ConfigurationManager_set_record_path(config_proxy, path, &error);
    check_error(error);
}
...
dbus_get_record_path(void)
{
    GError *error = NULL;
    gchar *path;
    org_ring_Ring_ConfigurationManager_get_record_path(config_proxy, &path, &error);
    check_error(error);
...
void dbus_set_record_playback_seek(gdouble value) {
    GError *error = NULL;
    org_ring_Ring_CallManager_record_playback_seek(call_proxy, value, &error);
    check_error(error);
}
...
{
    GError *error = NULL;
    org_ring_Ring_ConfigurationManager_set_is_always_recording(config_proxy, alwaysRec, &error);
    check_error(error);
}
...
gboolean dbus_get_is_always_recording(void)
{
    GError *error = NULL;
    gboolean alwaysRec;
    org_ring_Ring_ConfigurationManager_get_is_always_recording(config_proxy, &alwaysRec, &error);
    check_error(error);
...
{
    GError *error = NULL;
    org_ring_Ring_ConfigurationManager_set_history_limit(config_proxy, days, &error);
    check_error(error);
}
...
dbus_get_history_limit(void)
{
    GError *error = NULL;
    gint days = 30;
    org_ring_Ring_ConfigurationManager_get_history_limit(config_proxy, &days, &error);
    check_error(error);
...
{
    GError *error = NULL;
    org_ring_Ring_ConfigurationManager_clear_history(config_proxy, &error);
    check_error(error);
}
...
dbus_set_audio_manager(const gchar *api)
{
    GError *error = NULL;
    gboolean result;
    org_ring_Ring_ConfigurationManager_set_audio_manager(config_proxy, api, &result, &error);
    check_error(error);
    return result;
}
...
dbus_get_audio_manager(void)
{
    gchar *api;
    GError *error = NULL;
    org_ring_Ring_ConfigurationManager_get_audio_manager(config_proxy, &api, &error);
    check_error(error);
...
dbus_get_supported_audio_managers()
{
    GError *error = NULL;
    gchar **array = NULL;
    org_ring_Ring_ConfigurationManager_get_supported_audio_managers(config_proxy, &array, &error);
    check_error(error);
...
dbus_video_get_default_device()
{
    ...
    org_ring_Ring_VideoManager_get_default_device(video_proxy, &str, &error);
    check_error(error);
...
{
    GError *error = NULL;
    org_ring_Ring_VideoManager_set_default_device(video_proxy, name, &error);
    check_error(error);
}
...
dbus_video_get_settings(const gchar *name)
{
    ...
    org_ring_Ring_VideoManager_get_settings(video_proxy, name, &settings, &error);
    check_error(error);
...
{
    GError *error = NULL;
    org_ring_Ring_VideoManager_apply_settings(video_proxy, name, settings, &error);
    check_error(error);
}
...
dbus_video_get_device_list()
{
    ...
    org_ring_Ring_VideoManager_get_device_list(video_proxy, &array, &error);
    check_error(error);
    return array;
}
...
dbus_video_get_capabilities(const gchar *name)
{
    ...
    org_ring_Ring_VideoManager_get_capabilities(video_proxy, name, &cap, &error);
    check_error(error);
...
dbus_get_hook_settings(void)
{
    ...
    org_ring_Ring_ConfigurationManager_get_hook_settings(config_proxy, &results, &error);
    check_error(error);
...
{
    GError *error = NULL;
    org_ring_Ring_ConfigurationManager_set_hook_settings(config_proxy, settings, &error);
    check_error(error);
}
...
dbus_get_call_details(const gchar *callID)
{
    GError *error = NULL;
    GHashTable *details = NULL;
    org_ring_Ring_CallManager_get_call_details(call_proxy, callID, &details, &error);
    check_error(error);
...
dbus_get_call_list(void)
{
    GError *error = NULL;
    gchar **list = NULL;
    org_ring_Ring_CallManager_get_call_list(call_proxy, &list, &error);
    check_error(error);
...
dbus_get_conference_list(void)
{
    GError *error = NULL;
    gchar **list = NULL;
    org_ring_Ring_CallManager_get_conference_list(call_proxy, &list, &error);
    check_error(error);
...
dbus_get_display_names(const gchar *confID)
{
    ...
    org_ring_Ring_CallManager_get_display_names(call_proxy, confID, &list, &error);
    check_error(error);
...
dbus_get_participant_list(const gchar *confID)
{
    ...
    org_ring_Ring_CallManager_get_participant_list(call_proxy, confID, &list, &error);
    check_error(error);
...
dbus_get_conference_id(const gchar *callID)
{
    gchar *confID = NULL;
    GError *error = NULL;
    org_ring_Ring_CallManager_get_conference_id(call_proxy, callID, &confID, &error);
    check_error(error);
    return confID;
}
...
dbus_get_conference_details(const gchar *confID)
{
    GError *error = NULL;
    GHashTable *details = NULL;
    org_ring_Ring_CallManager_get_conference_details(call_proxy, confID, &details, &error);
    check_error(error);
...
{
    GError *error = NULL;
    org_ring_Ring_ConfigurationManager_set_accounts_order(config_proxy, order, &error);
    check_error(error);
}
...
{
    org_ring_Ring_ConfigurationManager_get_history_async(config_proxy, get_history_async_cb, id);
}
...
{
    GError *error = NULL;
    org_ring_Ring_CallManager_set_sa_sverified(call_proxy, c->_callID, &error);
    check_error(error);
}
...
{
    GError *error = NULL;
    org_ring_Ring_CallManager_reset_sa_sverified(call_proxy, c->_callID, &error);
    check_error(error);
}
...
{
    GError *error = NULL;
    org_ring_Ring_CallManager_set_confirm_go_clear(call_proxy, c->_callID, &error);
    check_error(error);
}
...
{
    GError *error = NULL;
    org_ring_Ring_CallManager_request_go_clear(call_proxy, c->_callID, &error);
    check_error(error);
}
...
dbus_get_supported_tls_method()
{
    GError *error = NULL;
    gchar **array = NULL;
    org_ring_Ring_ConfigurationManager_get_supported_tls_method(config_proxy, &array, &error);
    check_error(error);
...
dbus_get_tls_settings_default(void)
{
    GError *error = NULL;
    GHashTable *results = NULL;
    org_ring_Ring_ConfigurationManager_get_tls_settings_default(config_proxy, &results, &error);
    check_error(error);
...
dbus_check_certificate(const gchar *capath, const gchar *certpath)
{
    GError *error = NULL;
    gboolean result;
    org_ring_Ring_ConfigurationManager_check_certificate_validity(config_proxy, capath, certpath, &result, &error);
    check_error(error);
...
dbus_certificate_contains_private_key(const gchar *filepath)
{
    GError *error = NULL;
    gboolean result;
    org_ring_Ring_ConfigurationManager_check_for_private_key(config_proxy, filepath, &result, &error);
    check_error(error);
...
dbus_get_address_from_interface_name(const gchar *interface)
{
    GError *error = NULL;
    gchar *address = NULL;
    org_ring_Ring_ConfigurationManager_get_addr_from_interface_name(config_proxy, interface, &address, &error);
    check_error(error);
...
dbus_get_all_ip_interface(void)
{
    ...
    org_ring_Ring_ConfigurationManager_get_all_ip_interface(config_proxy, &array, &error);
    check_error(error);
...
dbus_get_all_ip_interface_by_name(void)
{
    ...
    org_ring_Ring_ConfigurationManager_get_all_ip_interface_by_name(config_proxy, &array, &error);
    check_error(error);
...
dbus_get_shortcuts(void)
{
    ...
    org_ring_Ring_ConfigurationManager_get_shortcuts(config_proxy, &shortcuts, &error);
    check_error(error);
...
{
    GError *error = NULL;
    org_ring_Ring_ConfigurationManager_set_shortcuts(config_proxy, shortcuts, &error);
    check_error(error);
}
...
{
    GError *error = NULL;
    org_ring_Ring_CallManager_send_text_message(call_proxy, callID, message, &error);
    check_error(error);
}
...
dbus_start_video_camera()
{
    ...
    org_ring_Ring_VideoManager_start_camera_async(video_proxy, video_camera_async_cb, NULL);
}
...
{
    set_camera_button_sensitivity(FALSE);
    org_ring_Ring_VideoManager_stop_camera_async(video_proxy, video_camera_async_cb, NULL);
}
...
dbus_has_video_camera_started()
{
    ...
    org_ring_Ring_VideoManager_has_camera_started(video_proxy, &started, &error);
    check_error(error);
    return started;
}
#endif
...
{
    GError *error = NULL;
    org_ring_Ring_PresenceManager_publish(presence_proxy, accountID,status, "Tout va bien.", NULL);
    check_error(error);
}
...
{
    GError *error = NULL;
    org_ring_Ring_PresenceManager_subscribe_buddy(presence_proxy, accountID, uri, flag, NULL);
    check_error(error);
}
