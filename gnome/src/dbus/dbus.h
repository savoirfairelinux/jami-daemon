 ...
 */
GArray *dbus_get_active_codec_list(const gchar *accountID);
void dbus_set_active_codec_list(const gchar *accountID, const GArray *list);
GHashTable* dbus_get_codec_details(const gchar *accountID, guint codecId);
