...
static void
volume_bar_cb(GSimpleAction *action, GVariant *state, SFLPhoneClient *client)
{
...
static void
dialpad_bar_cb(GSimpleAction *action, GVariant *state, SFLPhoneClient *client)
{
    // get the requested state and apply it
    gboolean requested = g_variant_get_boolean(state);
    g_simple_action_set_state(action, g_variant_new_boolean(requested));
...
#ifdef SFL_PRESENCE
static void
toggle_presence_window_cb(GSimpleAction *action, GVariant *state, SFLPhoneClient *client)
{
    // get the requested state and apply it
    gboolean requested = g_variant_get_boolean(state);
    g_simple_action_set_state(action, g_variant_new_boolean(requested));
 ...
 */
static void
call_transfer_cb(G_GNUC_UNUSED GSimpleAction *action, G_GNUC_UNUSED GVariant *param, SFLPhoneClient *client)
{
...
static void
toggle_history_cb(GSimpleAction *action, GVariant *state, SFLPhoneClient *client)
{
    // get the requested state and apply it
    gboolean requested = g_variant_get_boolean(state);
    g_simple_action_set_state(action, g_variant_new_boolean(requested));
...
static void
toggle_addressbook_cb(GSimpleAction *action, GVariant *state, SFLPhoneClient *client)
{
    // get the requested state and apply it
    gboolean requested = g_variant_get_boolean(state);
    g_simple_action_set_state(action, g_variant_new_boolean(requested));
...
static const GActionEntry sflphone_actions[] =
{
    ...
    { "hold", NULL, NULL, "false", call_hold},
    { "message", call_im, NULL, NULL, NULL},
    { "screenshare", NULL, NULL, "false", call_screenshare},
    ...
    { "show-address-book", NULL, NULL, "false", toggle_addressbook_cb},
    { "show-history", NULL, NULL, "false", toggle_history_cb},
    { "show-volume-controls", NULL, NULL, "true", volume_bar_cb},
    { "show-dialpad", NULL, NULL, "true", dialpad_bar_cb},
#ifdef SFL_PRESENCE
    { "show-buddy-list", NULL, NULL, "false", toggle_presence_window_cb}
#endif
};
