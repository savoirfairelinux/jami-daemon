...
static void
volume_bar_cb(GSimpleAction *action, GVariant *state, gpointer client)
{
    ...
    if (requested != show_volume)
        g_settings_set_boolean(((SFLPhoneClient *)client)->settings, "show-volume-controls", requested);
}

static void
dialpad_bar_cb(GSimpleAction *action, GVariant *state, gpointer client)
{
    // get the requested state and apply it
    gboolean requested = g_variant_get_boolean(state);
    g_simple_action_set_state(action, g_variant_new_boolean(requested));
    ...
    const gboolean conf_dialpad = g_settings_get_boolean(((SFLPhoneClient *)client)->settings, "show-dialpad");
    if (requested != conf_dialpad)
        g_settings_set_boolean(((SFLPhoneClient *)client)->settings, "show-dialpad", requested);
}
...
static void
help_about(G_GNUC_UNUSED GSimpleAction *action, G_GNUC_UNUSED GVariant *param, gpointer client)
{
    ...
    gtk_show_about_dialog(GTK_WINDOW(((SFLPhoneClient *)client)->win),
            "artists", artists,
            "authors", authors,
...
static void
call_minimize(G_GNUC_UNUSED GSimpleAction *action, G_GNUC_UNUSED GVariant *param, gpointer client)
{
    if (g_settings_get_boolean(((SFLPhoneClient *)client)->settings, "show-status-icon")) {
        gtk_widget_hide(((SFLPhoneClient *)client)->win);
        set_minimized(TRUE);
    } else
        sflphone_quit(FALSE, client);
}
...
static const GActionEntry sflphone_actions[] =
{
    ...
    { "record", NULL, NULL, NULL, NULL, {0} }, // callback connected manually to get id
    ...
    { "show-toolbar", NULL, NULL, "true", NULL, {0} },  // TODO: no way to hide toolbar currently
    { "transfer", NULL, NULL, NULL, NULL, {0} }, // callback connected manually to get id
