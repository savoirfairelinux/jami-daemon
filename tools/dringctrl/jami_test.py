...
class JamiTest(DRingCtrl):
    ...
    def testEnded(self, callId):
        ...
        self.iterator += 1
        self.failureRate = (self.failureCount / float(self.iterator))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--duration', help='Spcify the duration of the test (seconds)', default=30, type=int)
    parser.add_argument('--interval', help='Spcify the test interval (seconds)', default=60, type=int)
