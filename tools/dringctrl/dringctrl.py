...
if __name__ == "__main__":
    ...
    parser.add_argument('--accountype', help='Set account type when creating account', default='RING')
    parser.add_argument('--accountalias', help='Set account name when creating account')
