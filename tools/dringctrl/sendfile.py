...
parser.add_argument('--displayname', help='Name displayed to peer', metavar='<displayname>', type=str, default="")
...
tid = ctrl.sendFile(args.account, args.peer, args.filename, args.displayname)
