...
def getVSEnv(arch='x64', platform='', version=''):
    ...
    log.info('No error here in 106')
    log.info(stdout)
    out = stdout.decode('utf-8').split("\r\n")[5:-1]
    log.info('No error here in 107')
